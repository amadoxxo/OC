<?php
  ...
  class PDF_AutoPrint extends PDF_Javascript{
    ...
    function Header() {        
      ...
      $this->Ln(4.5);
      $this->setX($posx+165);
      $this->Cell(15,5,utf8_decode("Actividad Economica No. 5820 ICA 9,66"),0,0,'R');
      $this->Ln(4.5);
      $this->setX($posx+165);
    ...
    function Footer(){
      ...
      $this->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logo_footer_open.jpg', $posx, $posy+30, 178);
    }
  }
