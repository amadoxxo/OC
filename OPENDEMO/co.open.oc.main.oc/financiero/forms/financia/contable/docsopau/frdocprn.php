    ...
    function Header() {
      ...
      switch($cAlfa){
        ...
        case "TETRLXXXXX"://TRLXXXXX
          $this->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma1.jpg',11,11,35,10);
        break;
        case "TEADIMPEXX": // ADIMPEX
        case "DEADIMPEXX": // ADIMPEX
        case "ADIMPEXX": // ADIMPEX
        ...
        case "DEOPENEBCO":
        case "TEOPENEBCO":
          $this->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/opentecnologia.JPG',11,9,35,15);
        break;
        default://Logo open
          $this->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/opentecnologia.JPG',11,9,35,15);
        break;
