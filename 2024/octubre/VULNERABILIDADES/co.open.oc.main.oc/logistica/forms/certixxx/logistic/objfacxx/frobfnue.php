...
/**
 * Objeto Facturable.
 * --- Permite Crear un Nuevo Objeto Facturable.
        ...
        <tr>
          <td>
            <fieldset>
              ...
              <form name = 'frgrm' action = 'frobfgra.php' method = 'post' target='fmpro'>
                <center>
                    <table border = '0' cellpadding = '0' cellspacing = '0' width='460'>
                      ...
                      <tr>
                        <td Class = 'clase08' colspan = '6'>ID<br>
                          <input type = "text" Class = "letra" style = 'width:120' name = 'cObFidx' onBlur = "javascript:this.value=this.value.toUpperCase()" maxlength="4">
                        </td>
                        <td Class = 'clase08' colspan = '17'>Objeto Facturable<br>
                          <input type = "text" Class = "letra" style = 'width:340' name = 'cObfDes' onBlur = "javascript:this.value=this.value.toUpperCase()" maxlength="255">
                        </td>
                      </tr>
                      <tr>
...
switch ($_COOKIE['kModo']) {
  ...
  case "EDITAR":
    ...
    ?>
    <script languaje = "javascript">
      document.forms['frgrm']['cObFidx'].readOnly	 = true;
    </script>
  <?php break;
  case "VER":
    fnCargaData($cObFidx); ?>
...
<?php function fnCargaData($xObFidx) {
  ...
  $qObjFac .= "WHERE ";
  $qObjFac .= "obfidxxx = \"$xObFidx\" LIMIT 0,1";
  ...
  ?>
  <script language = "javascript">
    document.forms['frgrm']['cObFidx'].value = "<?php echo $vObjFac['obfidxxx'] ?>";
    document.forms['frgrm']['cObfDes'].value = "<?php echo $vObjFac['obfdesxx'] ?>";
    document.forms['frgrm']['dFecCre'].value = "<?php echo $vObjFac['regfcrex'] ?>";
    document.forms['frgrm']['dHorCre'].value = "<?php echo $vObjFac['reghcrex'] ?>";
    document.forms['frgrm']['dFecMod'].value = "<?php echo $vObjFac['regfmodx'] ?>";
    document.forms['frgrm']['dHorMod'].value = "<?php echo $vObjFac['reghmodx'] ?>";
    document.forms['frgrm']['cEstado'].value = "<?php echo $vObjFac['regestxx'] ?>";
  </script>
  <?php
} ?>
