...
<html>
  <head>
    ...
    <script language="javascript">
      ...
      function fnEnviarFacturaTbFacturaxnconsdo(xModo) {
        if(document.forms['frgrm']['vRecords'].value == 1){
          if(document.forms['frgrm']['oChkCom'].checked == true) {
            var mComDat   = document.forms['frgrm']['oChkCom'].id.split('~');
            ...
            var cComEst  = mComDat[5];

            if(cComEst == 'INACTIVO') {
              alert("No se pueden enviar comprobantes con estado INACTIVO");
            } else if (confirm("Esta seguro de enviar el comprobante "+mComDat[0]+"-"+mComDat[1]+"-"+mComDat[2]+"-"+mComDat[3]+" a la tabla tbFacturaXnconsDO?")) {
              document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
              document.cookie="kModo="+xModo+";path="+"/";
              document.forms['frtrabi']['cComId'].value   = cComId;
              document.forms['frtrabi']['cComCod'].value  = cComCod;
              document.forms['frtrabi']['cComCsc'].value  = cComCsc;
              document.forms['frtrabi']['cComCsc2'].value = cComCsc2;
              document.forms['frtrabi']['dRegFCre'].value = dRegFCre;
              document.forms['frtrabi']['cComEst'].value  = cComEst;
              document.forms['frtrabi'].action= "frintebi.php";
              document.forms['frtrabi'].submit();
            }
          }else{
  ...
  <body topmargin = "0" leftmargin = "0" rightmargin = "0" bottommargin = "0" marginheight = "0" marginwidth = "0">
    ...
    <form name = "frtrabi" action = "frintebi.php" method = "post" target="fmpro">
      <input type="hidden" name="cComId"   value="">
      <input type="hidden" name="cComCod"  value="">
      <input type="hidden" name="cComCsc"  value="">
      <input type="hidden" name="cComCsc2" value="">
      <input type="hidden" name="dRegFCre" value="">
      <input type="hidden" name="cComEst"  value="">
    </form>
