...
<html>
  <head>
    ...
    <script language="javascript">
      ...
      function fnConsultaInducida() {
        ...
        document.forms['frgrm'].action = 'fratimex.php';
        document.forms['frgrm'].target = 'cConInd';
        document.forms['frgrm'].submit();
        document.forms['frgrm'].target = 'fmwork';
        document.forms['frgrm'].action = 'fratiini.php';
        cWindow.focus();
      }
      ...
      function fnImprimir() {
        ...
        document.forms['frgrm'].action='fratiprn.php';
        document.forms['frgrm'].submit();
        document.forms['frgrm'].target='fmwork';
      }
    </script>
  ...
  <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginheight="0" marginwidth="0">
    <form name="frgrm" id="frgrm" action="fratiini.php" method="post" target="fmwork">
