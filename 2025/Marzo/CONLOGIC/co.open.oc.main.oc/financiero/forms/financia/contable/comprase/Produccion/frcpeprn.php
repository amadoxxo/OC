      ...
      $qCodDat .= "LEFT JOIN $cAlfa.SIAI0150 ON $cAlfa.fcod$cAno.teridxxx = $cAlfa.SIAI0150.CLIIDXXX ";
          ...
          // # DE PAGINAS //
              ...
              ##Fin Impresión de Logo de ADIMPEX en la parte superior derecha##
                ...
                case "DEALADUANA": //ALADUANA
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logoaladuana.jpg',16,8,30,15);
								...
								case "DEANDINOSX": //ANDINOSX
									$pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoAndinos2.jpeg', 20, $py + 6, 20, 19);
								break;
                ...
                case "TEMANATIAL":
                case "DEMANATIAL":
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logomanantial.jpg', 13, 9, 32, 10);
                break;
                case "DSVSASXX":
                case "TEDSVSASXX":
                case "DEDSVSASXX":
                ...
                if ($cAlfa == "DEGRUMALCO" || $cAlfa == "TEGRUMALCO" || $cAlfa == "GRUMALCO") {
                  ...
                  $pdf->MultiCell(100, 3, utf8_decode($cNombreAduana . "\n NIT. " . $cNitAduana), 0, 'C'); // TITULO DEL FORMULARIO //
				      ...
				      //Para q no mueste el nombre del cliente ni el nit del cliente...
				      switch($cAlfa){
				      	case "SIACOSIA":
				      	case "DESIACOSIP":
				      	case "TESIACOSIP":
  		  ...
  		  if ($nFilCoc > 0 && $nFilCod > 0) {
                ...
                case "TEGRUMALCO"://GRUMALCO
                case "DEGRUMALCO"://GRUMALCO
                	$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logomalco.jpg',12,$py+1,34,18);
	              break;
                case "ALADUANA": //ALADUANA
                case "TEALADUANA": //ALADUANA
                case "DEALADUANA": //ALADUANA
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logoaladuana.jpg',16,$py+4,30,15);
								...
								case "TEANDINOSX": //ANDINOSX
								case "DEANDINOSX": //ANDINOSX
									$pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoAndinos.jpeg', 20, $py + 6, 20, 19);
								break;
								case "GRUPOALC": //GRUPOALC
                case "TEGRUPOALC": //GRUPOALC
                case "DEGRUPOALC": //GRUPOALC
                ...
                case "TEMANATIAL":
                case "DEMANATIAL":
                  $pdf->MultiCell(100, 3, 'entra', 0, 'C');
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logomanantial.jpg', 13, $py + 5, 32, 10);
                break;
                case "DSVSASXX":
                case "TEDSVSASXX":
                case "DEDSVSASXX":
                ...
                break;
								...
								case "DECONNECTA":
								case "TECONNECTA":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logoconnecta.jpg',17,$py+4,25,15);
								break;
                case "CONLOGIC":
                case "DECONLOGIC":
                case "TECONLOGIC":
              ...
              $pdf->SetFont('verdana','',7);
                ...
                break;
  						...
  						$pdf->Cell($nPosDocCr,3,'DOC.CRUCE',0,0,'C');
  						$pdf->Cell($nPosPucDes,3,'DESCRIPCION',0,0,'C');
  						$pdf->Cell($nPosComObs,'OBSERVACIONES',0,0,'C');
  						$pdf->Cell(20,3,'DEBITO',0,0,'R');
  						$pdf->Cell(20,3,'CREDITO',0,0,'R');
  					}
