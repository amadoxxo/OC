<?php
  namespace openComex;
  /**
   * Observaciones Acciones del Tracking.
   * --- Descripcion: Permite guardar la observacion para las diferentes acciones del tracking.
  ...
  switch($_COOKIE['kModo']) {
    case "CERTIFICAFINANCIERO":
      $cTitulo = "Certificar para Financiero";
    break;
    case "APROBADOFINANCIERO":
      $cTitulo = "Aprobado Financiero";
    break;
    case "RECHAZOFINANCIERO":
      $cTitulo = "Aprobado Financiero";
    break;
    case "CERTIFICAFACTURA":
      $cTitulo = "Certifica para Facturación";
    break;
    case "ANULAR":
      $cTitulo = "Anular";
    break;
    ...
    <html>
      ...
      <script type="text/javascript">
        function fnGuardar(){
          ...
          window.opener.document.forms['frestado'].action = "frcergra.php";
          ...
          <tr>
            <td>
              <fieldset>
                ...
                <form name = "frgrm" action = "frcergra.php" method = "post">
