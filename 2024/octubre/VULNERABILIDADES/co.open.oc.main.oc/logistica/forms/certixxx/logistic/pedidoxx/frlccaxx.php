                  ...
                  <?php
                    switch ($gModo) {
                              ...
                              while ($xRMC = mysql_fetch_array($xCertiCab)) {
                                if (mysql_num_rows($xCertiCab) > 1) { ?>
                                  <tr>
                                    ...
                                    <td width = "100" class= "name">
                                      <a href = "javascript:window.opener.document.forms['frgrm']['cCerId'].value      = '<?php echo $xRMC['mifidxxx']?>';
                                ...
                                <?php
                                  ...
                                  <script language="javascript">
                                    window.opener.document.forms['frgrm']['cCerId'].value      = '<?php echo $xRMC['mifidxxx'] ?>';
                                    window.opener.document.forms['frgrm']['cCerComId'].value   = '<?php echo $xRMC['comidxxx'] ?>';
                                    window.opener.document.forms['frgrm']['cCerComCod'].value  = '<?php echo $xRMC['comcodxx'] ?>';
                                    window.opener.document.forms['frgrm']['cCerComCsc'].value  = '<?php echo $xRMC['comcscxx'] ?>';
                                    window.opener.document.forms['frgrm']['cCerComCsc2'].value = '<?php echo $xRMC['comcsc2x'] ?>';
                      ...
                      case "VALID":
                        ...
                        if (mysql_num_rows($xCertiCab) > 0){
                          ...
                          if (mysql_num_rows($xCertiCab) == 1){ 
                            ?>
                            <script language = "javascript">
                              parent.fmwork.document.forms['frgrm']['cCerId'].value      = '<?php echo $vCertiCab['mifidxxx'] ?>';
                      ...
                      case "EXACT":
                        ...
                        $qCertiCab .= "$cAlfa.lcca$cPerAno.comcodxx = \"$gComCod\" AND ";
                        $qCertiCab .= "$cAlfa.lcca$cPerAno.comcscxx = \"$gComCsc\" AND ";
                        $qCertiCab .= "$cAlfa.lcca$cPerAno.comcsc2x = \"$gComCsc2\" AND ";
                        if ($gCliId != "") {
                          $qCertiCab .= "$cAlfa.lcca$cPerAno.cliidxxx = \"$gCliId\" AND ";
                        }
                        $qCertiCab .= "$cAlfa.lcca$cPerAno.regestxx IN (\"CERTIFICADO\",\"PREFACTURADO_PARCIAL\",\"FACTURADO_PARCIAL\") ";
                        ...
                        <?php
                          ...
                          <script language = "javascript">
                            parent.fmwork.document.forms['frgrm']['cCerId'].value      = '';
                            parent.fmwork.document.forms['frgrm']['cCerComId'].value   = '';
                            parent.fmwork.document.forms['frgrm']['cCerComCod'].value  = '';
                            parent.fmwork.document.forms['frgrm']['cCerComCsc'].value  = '';
                            parent.fmwork.document.forms['frgrm']['cCerComCsc2'].value = '';
                          </script>
                        <?php
                        }
                      break;
