  	  							...
  	  							case "VALID":
  	  								...
  	  								if (mysql_num_rows($xDatDoi) == 1) {
  	  									...
  	  									<script languaje = "javascript">
  	  										parent.fmwork.document.forms['frgrm']['cComId'].value   = "<?php echo $xMtzDo['comidxxx']?>";
  	  										parent.fmwork.document.forms['frgrm']['cComCod'].value  = "<?php echo $xMtzDo['comcodxx']?>";
														...
														<?php while ($xRDoc = mysql_fetch_array($xDatDoi)) { ?>
															<tr>
																...
																<td width = "150" class= "name">
																	<a href = "javascript:window.opener.document.forms['frgrm']['cComId'].value   ='<?php echo $xRDoc['comidxxx'] ?>';
	  									                                  window.opener.document.forms['frgrm']['cComCod'].value  ='<?php echo $xRDoc['comcodxx'] ?>';
