    ...
    <script type="text/javascript">
      function f_Pegar(){
        if(document.forms['frgrm']['cMemo'].value != ""){
          ...
          alert('Debe Pegar los Numero de Do, Verifique.');
        }
      }
    </script>
				...
				<tr>
					<td>
						<fieldset>
	  					...
	  					<form name = "frgrm" action = "frfac20g.php" method = "post" target = "framepro">
	  						<input type="hidden" name="cModo"      value="PEGARDO">
	  						<input type="hidden" name="cTabla_GEN" value="<?php echo $gTabla_GEN ?>">
	  						<input type="hidden" name="cTabla_DOS" value="<?php echo $gTabla_DOS ?>">
	  						<input type="hidden" name="cFacId"     value="<?php echo $gFacId ?>">
	  						<input type="hidden" name="nSecuencia" value="<?php echo $gSecuencia ?>">
	  						<input type="hidden" name="nValueSec" value="<?php echo $gValueSec ?>">
