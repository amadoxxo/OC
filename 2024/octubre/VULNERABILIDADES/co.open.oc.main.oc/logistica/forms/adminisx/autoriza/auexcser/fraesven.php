...
<html>
  ...
  <head>
    ...
    <script language="javascript">
      ...
      function fnCargaData() { //Arma cadena para guardar en campo matriz de la sys00121
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="560">
                          ...
                          ?>
                            <tr>
                              ...
                              <td bgcolor="<?php echo $vSysStr['system_row_impar_color_ini'] ?>" class="letra7" style="padding-left:5px;padding-right:2px;border:1px solid #E6E6E6"><?php echo $xRT['subdesxx'] ?></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" id='bnt_Paso2' width="560">
            <tr>
              ...
              <td width="91" height="21" class="name">
                <input type="button" class="name" name="Btn_Guardar" value="Guardar" style="background:url(<?php echo $cPlesk_Skin_Directory ?>/btn_ok_bg.gif);width:91;height:21;border:0px;" onclick="javascript:fnCargaData();
