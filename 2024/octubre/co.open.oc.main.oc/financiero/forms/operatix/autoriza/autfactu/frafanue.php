   	...
   	<script language = 'javascript'>
		...
		function f_Links(xLink,xSwitch,xIteration) {
			...
			switch (xLink){
				...
				case "cDocId":
					if (xSwitch == "VALID") {						
						var zRuta  = "frafa121.php?gWhat=VALID&gFunction=cDocId&cDocId="+
	  				...
	  				var zNx     = (zX-600)/2;
						...
						var zRuta   = "frafa121.php?gWhat=WINDOW&gFunction=cDocId&cDocId="+
						document.frgrm.cDocId.value.toUpperCase()+"";
							 	...
							 	<center>
      							<table border = '0' cellpadding = '0' cellspacing = '0' width='400'>
  							 			...
  							 			<tr>  							 			
  											...
  											<td Class = "clase08" colspan = "7">
  												<a href = "javascript:document.frgrm.cSucId.value  = '';
  																			          ...
  																			          this.style.background='<?php echo $vSysStr['system_imput_onblur_color'] ?>'
  																			  		  ...
  																			  		  "
  																							 id="IdDoc"> DO </a><br>
  												<input type = 'text' Class = 'letra' style = 'width:140' name = 'cDocId' maxlength="20"
  											...
  											<td Class = 'clase08' colspan = '3'>SUF<br>
  												<input type = 'text' Class = 'letra' style = 'width:60' name = 'cDocSuf' readonly>
  											</td>
  											<td Class = 'clase08' colspan = '8'> OPERACION <br>
  												<input type = 'text' Class = 'letra' style = 'width:160' name = 'cDocTip' readonly>
  							 				</td>												  											 											
  										</tr>
  										<tr>  											   										
