                    ...
                    case "VALID":
                      switch ($gFunction) {
                        case "cDocNro":
                          ...
                          $qDatDoi .= "doccomex, ";
                          $qDatDoi .= "docsufxx  ";
                          $qDatDoi .= "FROM $cAlfa.ffoi0000 ";
                          $qDatDoi .= "WHERE doccomex = \"$gDocNro\" AND  ";
                          $qDatDoi .= "forobsli <> \"\" ";
                        ...
                        default:
                          ...
                          $qDatDoi .= "seridxxx ";
                          $qDatDoi .= "FROM $cAlfa.ffoi0000 ";
                          $qDatDoi .= "WHERE seridxxx = \"$gSerId\" AND  ";
                          $qDatDoi .= "forobsli <> \"\" ";
                          $xDatDoi = f_MySql("SELECT","",$qDatDoi,$xConexion01,"");
                        break;
                      }
                        ...
                        switch ($gFunction) {
                          case "cDocNro": ?>
                            <script languaje = "javascript">
                              ...
                              parent.fmwork.document.forms['frgrm']['cDocNro'].value  = "<?php echo $xMtzDo['doccomex']?>";
                    ...
                    case "WINDOW":
                      ...
                      switch ($gFunction) {
                        case "cDocNro":
                          ...
                          $qDatDoi .= "docsufxx  ";
                          $qDatDoi .= "FROM $cAlfa.ffoi0000 ";
                          $qDatDoi .= "WHERE doccomex LIKE \"%$gDocNro%\" AND  ";
                          $qDatDoi .= "regestxx = \"FACTURADO\" ";
                        break;
                        default:
                          $qDatDoi  = "SELECT DISTINCT ";
                          $qDatDoi .= "seridxxx ";
                          $qDatDoi .= "FROM $cAlfa.ffoi0000 ";
                          $qDatDoi .= "WHERE seridxxx LIKE \"%$gSerId%\" AND  ";
                          $qDatDoi .= "regestxx = \"FACTURADO\" ";
                        break;
                      }
                      $xDatDoi = f_MySql("SELECT","",$qDatDoi,$xConexion01,"");
                                  ...
                                  <tr>
                                    ...
                                    <td width = "200" class= "name">
                                      <a href = "javascript:window.opener.document.forms['frgrm']['cSucId'].value   ='<?php echo $xRDoc['sucidxxx'] ?>';
                                                            window.opener.document.forms['frgrm']['cDocNro'].value  ='<?php echo $xRDoc['doccomex'] ?>';
                                                            window.opener.document.forms['frgrm']['cDocSuf'].value  ='<?php echo $xRDoc['docsufxx'] ?>';
                                                            window.close()"><?php echo $xRDoc['doccomex'] ?></a></td>
