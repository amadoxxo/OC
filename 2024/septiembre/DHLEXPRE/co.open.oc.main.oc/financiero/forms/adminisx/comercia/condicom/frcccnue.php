...
<html>
	<head>
    	...
    	function f_Links(xLink,xSwitch,xSecuencia='') {
          ...
          case "cUmeId":
            if (xSwitch == "VALID") {
							var zRuta  = "frccc157.php?gWhat=VALID"+
                                        "&gFunction="+xLink+
                                        "&gSecuencia="+xSecuencia+
                                        "&gUmeId="+document.forms['frgrm']['cUmeId'+xSecuencia].value.toUpperCase();
              ...
              if (xSwitch == "WINDOW") {
                var zNx     = (zX-600)/2;
								...
								var zWinPro = 'width=600,scrollbars=1,height=250,left='+zNx+',top='+zNy;
								var zRuta   = "frccc157.php?gWhat=WINDOW"+
                                           "&gFunction="+xLink+
                                           "&gSecuencia="+xSecuencia+
                                           "&gUmeId="+document.forms['frgrm']['cUmeId'+xSecuencia].value.toUpperCase();
                ...
                if (xSwitch == "EXACT") {
									var zRuta  = "frccc157.php?gWhat=EXACT"+
                                            "&gFunction="+xLink+
                                            "&gSecuencia="+xSecuencia+
                                            "&gUmeId="+document.forms['frgrm']['cUmeId'+xSecuencia].value.toUpperCase();
          ...
          case "cCtoId":
            if (xSwitch == "VALID") {
							var zRuta  = "frccccto.php?gWhat=VALID"+
                                        "&gFunction="+xLink+
                                        "&gSecuencia="+xSecuencia+
              ...
              if (xSwitch == "WINDOW") {
                var zNx     = (zX-600)/2;
								...
								var zWinPro = 'width=600,scrollbars=1,height=250,left='+zNx+',top='+zNy;
								var zRuta   = "frccccto.php?gWhat=WINDOW"+
                                           "&gFunction="+xLink+
                                           "&gSecuencia="+xSecuencia+
                                           "&gCtoId="+document.forms['frgrm']['cCtoId'+xSecuencia].value.toUpperCase();
                ...
                if (xSwitch == "EXACT") {
									var zRuta  = "frccccto.php?gWhat=EXACT"+
                                            "&gFunction="+xLink+
                                            "&gSecuencia="+xSecuencia+
                                            "&gCtoId="+document.forms['frgrm']['cCtoId'+xSecuencia].value.toUpperCase();
      ...
      function fnAddNewRowConcepto(xTabla) {
      
        var cGrid      = document.getElementById(xTabla);
        var nLastRow   = cGrid.rows.length;
        var nSecuencia = nLastRow+1;
        var cTableRow  = cGrid.insertRow(nLastRow);
        var cCtoId     = 'cCtoId' + nSecuencia;   // Concepto
        var cCtoDes    = 'cCtoDes' + nSecuencia;  // Descripcion
        var cUmeId     = 'cUmeId' + nSecuencia;   // Unidad Medida
        var cVlrUnit   = 'cVlrUnit' + nSecuencia; // Valor Unitario
        var oBtnDel    = 'oBtnDel' + nSecuencia;  // Boton de Borrar Row
        
        TD_xAll = cTableRow.insertCell(0);
        TD_xAll.style.width  = "120px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:120;text-align:left' name = '"+cCtoId+"' id = '"+cCtoId+"' onBlur='javascript: f_Links(\"cCtoId\",\"VALID\",\""+nSecuencia+"\")' onKeydown = 'javascript:if(event.keyCode == 13){ f_Links(\"cCtoId\",\"VALID\",\""+nSecuencia+"\") }'>";

        TD_xAll = cTableRow.insertCell(1);
        TD_xAll.style.width  = "180px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:180;text-align:left' name = '"+cCtoDes+"' id = '"+cCtoDes+"' readonly>";

        TD_xAll = cTableRow.insertCell(2);
        TD_xAll.style.width  = "140px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:140;text-align:left' name = '"+cUmeId+"' id = '"+cUmeId+"' onBlur='javascript: f_Links(\"cUmeId\",\"VALID\",\""+nSecuencia+"\")' onKeydown = 'javascript:if(event.keyCode == 13){ f_Links(\"cUmeId\",\"VALID\",\""+nSecuencia+"\") }'>";
        
        TD_xAll = cTableRow.insertCell(3);
        TD_xAll.style.width  = "120px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:120;text-align:left' name = '"+cVlrUnit+"' id = '"+cVlrUnit+"'>";

        TD_xAll = cTableRow.insertCell(4);
        TD_xAll.style.width  = "20px";
        TD_xAll.innerHTML    = "<input type = 'button' style = 'width:020;text-align:center' name = "+oBtnDel+" id = "+oBtnDel+" value = 'X' "+
                                "onClick = 'javascript:fnDeleteRowConcepto(this.value,\""+nSecuencia+"\",\""+xTabla+"\");'>";

        document.forms['frgrm']['nSecuencia_' + xTabla].value = nSecuencia;
      }

      function fnDeleteRowConcepto(xNumRow,xSecuencia,xTabla) {
        var cGrid = document.getElementById(xTabla);
        var nLastRow = cGrid.rows.length;
        if (nLastRow > 1 && xNumRow == "X") {
          $cConDes = "";
          if(document.forms['frgrm']['cCtoId' + xSecuencia].value != "") {
            $cConDes = " ["+document.forms['frgrm']['cCtoId' + xSecuencia].value+"]";
          }
          if (confirm("Realmente Desea Eliminar el Concepto"+ $cConDes +"?")){ 
            if(xSecuencia < nLastRow){
              var j=0;
              for(var i=xSecuencia;i<nLastRow;i++){
                j = parseFloat(i)+1;
                ...
                document.forms['frgrm']['cUmeId' + i].value = document.forms['frgrm']['cUmeId' + j].value;
                document.forms['frgrm']['cVlrUnit' + i].value = document.forms['frgrm']['cVlrUnit' + j].value; 
              }
            }
            cGrid.deleteRow(nLastRow - 1);
            document.forms['frgrm']['nSecuencia_' + xTabla].value = nLastRow - 1;
      ...
      function fnBorrarValorConcepto(xTabla){
        document.getElementById(xTabla).innerHTML = "";
        fnAddNewRowConcepto(xTabla);
      }
    </script>
	</head>
	<body topmargin = 0 leftmargin = 0 margnwidth = 0 marginheight = 0 style = 'margin-right:0'>
		<center>
			<table border ="0" cellpadding="0" cellspacing="0" width="600">
                ...
                <input type = "hidden" name = "nSecuencia_Grid_ValorConcepto">
							 	<center>
      							<table border = '0' cellpadding = '0' cellspacing = '0' width='600'>
                      ...
                      <tr>
                        ...
                        <?php if (f_InList($cAlfa,"ALADUANA","DEALADUANA","TEALADUANA")) { ?>
                          <tr>
                            <td Class = "clase08" colspan = "30">
                              <fieldset>
                              <legend>Valores Unitarios Conceptos Pagos a Terceros</legend>
                                <table border = '0' cellpadding = '0' cellspacing = '0' width='580'>
                                  ...
                                  <tr>
                                    <td colspan="30" class= "clase08" align="right">
                                      <?php if ($_COOKIE['kModo'] != "VER") { ?>
                                        <img src = "<?php echo $cPlesk_Skin_Directory ?>/btn_create-dir_bg.gif" onClick = "javascript:fnAddNewRowConcepto('Grid_ValorConcepto')" style = "cursor:pointer" title="Adicionar">
                                        <img src = "<?php echo $cPlesk_Skin_Directory ?>/b_drop.png" onClick = "javascript:fnBorrarValorConcepto('Grid_ValorConcepto')" style = "cursor:pointer" title="Eliminar Todos">
                                      <?php } ?>
                                    </td>                       
                                  </tr>
                                  <tr>
                                    <td class = "clase08" colspan="06" align="left">Concepto</td>                                                          
                                    <td class = "clase08" colspan="09" align="left">Descripci&oacute;n</td>
                                    <td class = "clase08" colspan="07" align="left">Unidad Medida</td>
                                    <td class = "clase08" colspan="07" align="left">Valor Unitario</td>
                                    <td class = "clase08" colspan="01" align="right">&nbsp;</td>                       
                                  </tr>
                                </table>
                                <table border = "0" cellpadding = "0" cellspacing = "0" width = "580" id = "Grid_ValorConcepto"></table>
                              </fieldset>
														</td>
													</tr>
                        <?php } ?>
		...
		switch ($_COOKIE['kModo']) {
            ...
            case "TEALADUANA":
            case "DEALADUANA":
              fnAddNewRowConcepto('Grid_ValorConcepto');
            break;
            default:
              //No hace nada
            break;
      ...
      $qDatCcc .= "IF($cAlfa.A.CLINOMXX !=\"\",$cAlfa.A.CLINOMXX,CONCAT($cAlfa.A.CLIAPE1X,\" \",$cAlfa.A.CLIAPE2X,\" \",$cAlfa.A.CLINOM1X,\" \",$cAlfa.A.CLINOM2X)) AS clinom2x, ";
        ...
        switch ($cAlfa) {
          ...
          case 'DEALADUANA':
          case 'TEALADUANA':
            $mConceptos = f_explode_array($xRDC['cccvlcto'],"|","~");
            $mDesCon = array();
            for ($i=0;$i<count($mConceptos);$i++) {
              if ($mConceptos[$i][0] != "") {
                $qCto119  = "SELECT ";
                $qCto119 .= "ctoidxxx, ";
                $qCto119 .= "COALESCE(NULLIF(ctodesxx, \"\"), ctodesxp) AS ctodesxx, ";
                $qCto119 .= "regestxx ";
                $qCto119 .= "FROM $cAlfa.fpar0119 ";
                $qCto119 .= "WHERE ";
                $qCto119 .= "ctopccxx = \"SI\" AND ";
                $qCto119 .= "ctoidxxx = \"{$mConceptos[$i][0]}\" LIMIT 0,1";
                $xCto119  = f_MySql("SELECT","",$qCto119,$xConexion01,"");
                // f_Mensaje(__FILE__,__LINE__,$qCto119."~".mysql_num_rows($xCto119));
                if (mysql_num_rows($xCto119) > 0) {
                  $vConcepto = mysql_fetch_array($xCto119);
                } else {
                  // Consulta conceptos contables causaciones automaticas
                  $qCto121  = "SELECT ";
                  $qCto121 .= "ctoidxxx, ";
                  $qCto121 .= "ctodesxx, ";
                  $qCto121 .= "regestxx ";
                  ...
                  $qCto121 .= "WHERE ";
                  $qCto121 .= "ctotipxx = \"TERCEROS\" AND ";
                  $qCto121 .= "ctoidxxx = \"{$mConceptos[$i][0]}\" LIMIT 0,1";
                  $xCto121  = f_MySql("SELECT","",$qCto121,$xConexion01,"");
                  // f_Mensaje(__FILE__,__LINE__,$qCto121."~".mysql_num_rows($xCto121));
                  if (mysql_num_rows($xCto121) > 0) {
                    $vConcepto = mysql_fetch_array($xCto121);
                  }
                }
                $mDesCon[$mConceptos[$i][0]] = $vConcepto["ctodesxx"];
              }
            }
          break;
        }
          ...
          if ("<?php echo $cAlfa ?>" == "ALADUANA" || "<?php echo $cAlfa ?>" == "DEALADUANA" || "<?php echo $cAlfa ?>" == "TEALADUANA") {
            <?php
						$mConceptos = f_explode_array($xRDC['cccvlcto'],"|","~");
						$nCanCon  = 0; 
            if(count($mConceptos) > 0) {
              for ($i=0;$i<count($mConceptos);$i++) {
                if ($mConceptos[$i][0] != "") { 
                  $nCanCon++; ?>
                  fnAddNewRowConcepto('Grid_ValorConcepto');
                  document.forms['frgrm']['cCtoId' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].value     = "<?php echo $mConceptos[$i][0] ?>";
                  document.forms['frgrm']['cCtoDes' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].value    = "<?php echo $mDesCon[$mConceptos[$i][0]] ?>";
                  document.forms['frgrm']['cUmeId' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].value     = "<?php echo $mConceptos[$i][1] ?>";
                  document.forms['frgrm']['cVlrUnit' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].value   = "<?php echo $mConceptos[$i][2] ?>";
                  if ("<?php echo $_COOKIE['kModo'] ?>" == "VER") {
                    document.forms['frgrm']['cCtoId' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].disabled = true;
                    document.forms['frgrm']['cUmeId' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].disabled = true;
                    document.forms['frgrm']['cVlrUnit' + document.forms['frgrm']['nSecuencia_Grid_ValorConcepto'].value].disabled = true;
                  }
                <?php }
              } 
            } else { ?>
              fnAddNewRowConcepto('Grid_ValorConcepto'); <?php
            } ?>
					}
