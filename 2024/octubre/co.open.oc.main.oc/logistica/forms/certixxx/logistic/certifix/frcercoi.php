<?php
  namespace openComex;
  /**
   * Formulario para consulta inducida en el traking de Certificaciones.
   * @author Juan Jose TrujilloCh. <juan.trujillo@openits.co>
   * @package opencomex
   * @version 001
   */
  ...
  <head>
    ...
    <script language="javascript">
      function fnEnviarDatos(){
        ...
        vDatos['cMifId']        = document.forms['frgrm']['cMifId'].value;
      ...
      function fnLinks(xLink,xSwitch) {
        ...
        switch (xLink) {
          ...
          case "cCliId":
            if (xSwitch == "VALID") {
              var zRuta  = "frcer150.php?gWhat=VALID&gFunction=cCliId&gCliId="+document.forms['frgrm']['cCliId'].value.toUpperCase();
              parent.fmpro.location = zRuta;
            } else {
              var zNx     = (nX-600)/2;
              var zNy     = (nY-250)/2;
              var zWinPro = 'width=600,scrollbars=1,height=250,left='+zNx+',top='+zNy;
              var zRuta   = "frcer150.php?gWhat=WINDOW&gFunction=cCliId&gCliId="+document.forms['frgrm']['cCliId'].value.toUpperCase();
              ...
              if(document.forms['frgrm']['cMifComCsc'].value.length < 1){
                ...
                if (xSwitch == "VALID") {
                  var zRuta = "frlmca00.php?gModo="+xSwitch+"&gFunction="+xLink+
                                          ...
                                          "&gComCsc="+document.forms['frgrm']['cMifComCsc'].value.toUpperCase();
                  parent.fmpro.location = zRuta;
                  ...
                  var zRuta = "frlmca00.php?gModo=EXACT&gFunction=" + xLink +
                                          "&cPerAno="+document.forms['frgrm']['cPerAno'].value +
                                          "&gComCod="+document.frgrm['cMifComCod'].value.toUpperCase() +
                                          "&gComCsc="+document.frgrm['cMifComCsc'].value.toUpperCase() +
                                          "&gComCsc2="+document.frgrm['cMifComCsc2'].value.toUpperCase();
                  parent.fmpro.location = zRuta;
                }
              }
            }
            ...
            <td>
              <fieldset>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="460">
                  ...
                  <tr>
                    <td class = "name" colspan="05"><br>M.I.F:
                    </td>
                    ...
                    <td Class = "name" colspan = "2"><br>Id<br>
                      <input type = "text" Class = "letra" style = "width:40" name = "cMifComId" value = "<?php echo $cMifComId ?>" readonly>
                    </td>
                    <td Class = "name" colspan = "2"><br>Cod
                      <input type = "text" Class = "letra" style = "width:40" name = "cMifComCod" value = "<?php echo $cMifComCod ?>" readonly>
                    </td>
                    <td Class = "name" colspan = "5"><br>M.I.F
                      <input type = "text" Class = "letra" style = "width:100" name = "cMifComCsc" value = "<?php echo $cMifComCsc ?>"
                    ...
                    <td Class = "name" colspan = "5"><br>Consecutivo 2
                      <input type = "text" Class = "letra" style = "width:100" name = "cMifComCsc2" value = "<?php echo $cMifComCsc2 ?>" readonly>
                    </td>
                  </tr>
                  <tr>
