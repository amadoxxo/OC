	  ...
	  <center>
			<table border ="0" cellpadding="0" cellspacing="0" width="450">
				<tr>
					<td>
						<fieldset>
			   			<legend>Intermediarios para el Tercero</legend>
	  					<form name = "frgrm" action = "" method = "post" target = "fmpro">
	  						<?php
	  						$qCliDat  = "SELECT CLIIDXXX,CONCAT(CLINOMXX,\" \",CLIAPE1X,\" \",CLIAPE2X,\" \",CLINOM1X,\" \",CLINOM2X) AS NOMBRE,REGESTXX ";
								...
								if (mysql_num_rows($xCliDat) > 0) {
					    			...
					    			<table cellspacing = "0" cellpadding = "1" border = "1" width = "450">
											<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
												...
												<td widht = "080" Class = "name"><center>Nit</center></td>
												<td widht = "300" Class = "name"><center>Nombre</center></td>
								          ...
								          if($y % 2 == 0) {
								          	$zColor = "{$vSysStr['system_row_par_color_ini']}";
											   	...
											   	<tr bgcolor = "<?php echo $zColor ?>" onmouseover="javascript:uRowColor(this,'<?php echo $vSysStr['system_row_select_color_ini'] ?>')" onmouseout="javascript:uRowColor(this,'<?php echo $zColor ?>')">
														...
														<td style='width: 080px' Class = 'letra7'><?php echo $zRCom['CLIIDXXX'] ?></td>
														<td style='width: 300px' Class = 'letra7'><?php echo substr($zRCom['NOMBRE'],0,45) ?></td>
