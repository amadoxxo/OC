      ...
      switch ($cTipo) {
                  ...
                  <tr>
                    ...
                    switch ($cAlfa) {
                      ...
                      case "TECONLOGIC":  //CONLOGIC ?>
                        <td class="name" style="font-size:14px;width:80px">
                          <img src="<?php echo $cPlesk_Skin_Directory ?>/logoconlogic.jpg" style="width:200;margin:5px;">
                        </td>
                      <?php	break;
        ...
        default:
          ...
          switch ($cAlfa) {
            ...
            case "DECONLOGIC":  //CONLOGIC
            case "TECONLOGIC":  //CONLOGIC
              $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoconlogic.jpg', 10, 11, 17, 13);
            break;
            case "OPENEBCO":    //OPENEBCO
            case "DEOPENEBCO":  //OPENEBCO
            case "TEOPENEBCO":  //OPENEBCO  
