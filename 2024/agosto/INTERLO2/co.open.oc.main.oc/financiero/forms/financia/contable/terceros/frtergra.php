 ...
 */
  ...
  switch ($_COOKIE['kModo']) {
    ...
    case "APLICAR":
      ...
      /***
       * Validando las Condiciones Tributarias - No Residente en el Pais para Facturacion
       */
      #Validando Autorretenedor
      if ($_POST['oCliArNr'] == 'SI') {
        $_POST['oCliArNr']    = "SI";
        $_POST['oCliArAreNr'] = ($_POST['oCliArAreNr'] == 'SI')?"SI":"NO";
        $_POST['oCliArAcrNr'] = ($_POST['oCliArAcrNr'] == 'SI')?"SI":"NO";
      } else {
        $_POST['oCliArNr']    = "NO";
        $_POST['oCliArAreNr'] = "NO";
        $_POST['oCliArAcrNr'] = "NO";
      }

      #Validando Agente Retenedor Renta No Residente
      ...
      #Validando Agente Retenedor CREE No Residente
    ...
    switch ($_COOKIE['kModo']) {
      case "NUEVO":
        ...
        $qInsert =  array(array('NAME'=>'CLIIDXXX','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['cTerId'])),'"'))     ,'CHECK'=>'SI'),
                          ...
                          array('NAME'=>'CLIARNRX','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['oCliArNr'])),'"'))   ,'CHECK'=>'NO'), //Autorretenedor No Residente
                          array('NAME'=>'CLIARENR','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['oCliArAreNr'])),'"')),'CHECK'=>'NO'), //Autorretenedor Renta No Residente
                          array('NAME'=>'CLIACRNR','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['oCliArAcrNr'])),'"')),'CHECK'=>'NO'), //Autorretenedor Cree No Residente
                          array('NAME'=>'CLIARRNR','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['oCliArrNr'])),'"'))  ,'CHECK'=>'NO'), //Autorretenedor No Residente
                          array('NAME'=>'CLIRCRNR','VALUE'=>str_replace($cBuscar01,$cReempl01,trim(trim(strtoupper($_POST['oCliArcrNr'])),'"')) ,'CHECK'=>'NO'), //Autorretenedor No Residente
