<?php
  namespace openComex;
  /**
   * Cargue Masivo de Movimiento - Matriz de Insumos Facturables.
   * --- Descripcion: Permite el Cargue Masivo de Movimiento a una Matriz de Insumos Facturables.
        ...
        <tr>
          <td>
            <form name = "frgrm" enctype='multipart/form-data' action = "frmifcag.php" method = "post" target="fmpro">
              ...
              <fieldset>
                <legend>Cargue Masivo de Movimiento</legend>
                <center>
                  <table border="0" cellpadding="0" cellspacing="0" width="620">
                    ...
                    <tr>
                      <td Class = "clase08" colspan="31">
                        <fieldset>
                          <legend>Cargue y Descargue</legend>
