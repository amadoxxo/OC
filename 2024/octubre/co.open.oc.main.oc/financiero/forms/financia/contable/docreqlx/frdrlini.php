<?php
  namespace openComex;
/**
 * Tracking Documento Requisitos Legales.
 * Este programa permite realizar consultas rapidas de los Documentos Requisitos Legales que se Encuentran en la Base de Datos.
 * @author
 * @package emisioncero
 */
...
<html>
	<head>
  	<LINK rel = 'stylesheet' href = '<?php echo $cSystem_Libs_JS_Directory ?>/estilo.css'>
   	...
   	<script language="javascript">
    	...
    	function f_Ver(xDrlId) {
      	var ruta = "frdrlnue.php?cDrlId="+xDrlId;
      	document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	document.cookie="kMenDes=Ver Documento Requisito Legal;path="+"/";
				...
				switch (document.forms['frgrm']['vRecords'].value) {
					case "1":
						if (document.forms['frgrm']['oChkCom'].checked == true) {
							...
							var ruta = "frdrlnue.php?cDrlId="+zMatriz[0];
      	      document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	      document.cookie="kMenDes=Editar Documento Requisito Legal;path="+"/";
				 ...
				 if (document.forms['frgrm']['vRecords'].value!="0"){
  				switch (document.forms['frgrm']['vRecords'].value) {
  					case "1":
  						if (document.forms['frgrm']['oChkCom'].checked == true) {
   						  var zMatriz = document.forms['frgrm']['oChkCom'].id.split('-');
   						  if (confirm("Esta Seguro de Cambiar el Estado del Documento Requisito Legal No. "+zMatriz[0]+" ?")) {
									document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
    							document.forms['frestado']['cDrlId'].value=zMatriz[0];
  ...
  <body topmargin = "0" leftmargin = "0" rightmargin = "0" bottommargin = "0" marginheight = "0" marginwidth = "0">
		<form name = "frestado" action = "frdrlgra.php" method = "post" target="fmpro">
			<input type = "hidden" name = "cDrlId" value = "">
      ...
      <?php
        ...
        $qDatDrl  = "SELECT * ";
	        ...
	        for ($i=0,$j=0;$i<count($zMatrizTmp);$i++) {
	          ...
	          $cCadena  = $zMatrizTmp[$i]['drlidxxx']."~";
	          $cCadena .= $zMatrizTmp[$i]['drldesxx']."~";
      ...
      <center>
       	<table width="95%" cellspacing="0" cellpadding="0" border="0">
         	<tr>
	       	  <td>
				      <fieldset>
   			        <legend>Documento Requisito Legal del Periodo Seleccionado (<?php echo count($zMatrizTra)?>)</legend>
     	         	<center>
     	       		...
     	       		<center>
         	         	...
         	         	<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
         	         		<td class="name" width="10%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','drlidxxx','ASC_NUM')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','drlidxxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','drlidxxx','')">Id</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "drlidxxx">
           	         		<script language="javascript">f_ButtonsAscDes('','drlidxxx','')</script>
           	         	</td>
           	         	<td class="name" width="40%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','drldesxx','ASC_AZ')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','drldesxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','drldesxx','')">Documento Requisito Legal</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "drldesxx">
           	         		<script language="javascript">f_ButtonsAscDes('','drldesxx','')</script>
           	         	</td>
 	                    ...
 	                    <?php for ($i=intval($vLimInf);$i<intval($vLimInf+$vLimSup);$i++) {
 	                    	if ($i < count($zMatrizTra)) { // Para Controlar el Error
	                   	    ...
	                   	    if($y % 2 == 0) {
		                      	...
		                      	<td class="letra7" width="10%"><a href = javascript:f_Ver('<?php echo $zMatrizTra[$i]['drlidxxx']?>')><?php echo $zMatrizTra[$i]['drlidxxx'] ?></a></td>
	       	                	<td class="letra7" width="40%"><?php echo $zMatrizTra[$i]['drldesxx'] ?></td>
	            	            ...
	            	            <td Class="letra7" width="02%" align="right"><input type="checkbox" name="oChkCom"  value = "<?php echo count($zMatrizTra) ?>"
	                   	    		id="<?php echo $zMatrizTra[$i]['drlidxxx'].'-'.$zMatrizTra[$i]['regestxx']?>"
