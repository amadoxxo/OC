    ...
    <LINK rel = "stylesheet" href = "<?php echo $cSystem_Libs_JS_Directory ?>/overlib.css">
        ...
        switch (xCondi) {
          case "CAG":
            if(document.forms['frgrm']['DocCagSi'].checked==true) {
              ...
              document.forms['frgrm']['DocC40HcNo'].checked=true;
              document.forms['frgrm']['DocC40HcSi'].checked=false;
              document.forms['frgrm']['oDocC40Hc'].value="NO";
              document.forms['frgrm']['cDocC40Hc'].value="";
              document.getElementById('cDocC40Hc').style.display= "none";
          ...
          case "C40HC":
            if(document.forms['frgrm']['DocC20Si'].checked==true ||
              ...
              document.forms['frgrm']['DocAC20Si'].checked==true ||
              document.forms['frgrm']['DocAC40Si'].checked==true ||
              document.forms['frgrm']['DocC40HcSi'].checked==true) {
              ...
              document.forms['frgrm']['cDocCsu'].value="";
              document.getElementById('cDocCsu').style.display= "none";
              document.forms['frgrm']['DocFurNo'].checked=true;
              document.forms['frgrm']['DocFurSi'].checked=false;
              document.forms['frgrm']['oDocFur'].value="NO";
              document.forms['frgrm']['cDocFur'].value="";
              document.getElementById('cDocFur').style.display= "none";
            }
          break;
          case "FUR":
            if(document.forms['frgrm']['DocFurSi'].checked==true ) {
              document.forms['frgrm']['DocC20No'].checked=true;
              document.forms['frgrm']['DocC20Si'].checked=false;
              document.forms['frgrm']['oDocC20'].value="NO";
              document.forms['frgrm']['cDocC20'].value="";
          ...
          case "CS":
            if(document.forms['frgrm']['DocCsSi'].checked==true ) {
              ...
              document.forms['frgrm']['cDocCsu'].value="";
              document.getElementById('cDocCsu').style.display= "none";
              document.forms['frgrm']['DocAC20No'].checked=true;
              document.forms['frgrm']['DocAC20Si'].checked=false;
              document.forms['frgrm']['DocAC40No'].checked=true;
              document.forms['frgrm']['DocAC40Si'].checked=false;
            }
          break;
          case "CSU":
          ...
          break;
          case "TVI":
              if(document.forms['frgrm']['DocTvaSi'].checked==true ) {
                document.forms['frgrm']['DocTvdSi'].checked=true;
                document.forms['frgrm']['DocTvdNo'].checked=false;
              }
          break;
          case "PRO":
              if(document.forms['frgrm']['DocProXSi'].checked==true ) {
                document.forms['frgrm']['DocCubSi'].checked=true;
                document.forms['frgrm']['DocCubNo'].checked=false;
                document.forms['frgrm']['cDocCub'].value="";
                document.getElementById('cDocCub').style.display= "block";
                document.forms['frgrm']['DocVlCubSi'].checked=true;
                document.forms['frgrm']['DocVlCubNo'].checked=false;
                document.getElementById('cDocVlCub').style.display= "block";
                document.forms['frgrm']['cDocVlCub'].value="";
              }else{
                document.forms['frgrm']['DocCubSi'].checked=false;
                document.forms['frgrm']['DocCubNo'].checked=true;
                document.forms['frgrm']['cDocCub'].value="";
                document.getElementById('cDocCub').style.display= "none";
                document.forms['frgrm']['DocVlCubSi'].checked=false;
                document.forms['frgrm']['DocVlCubNo'].checked=true;
                document.forms['frgrm']['cDocVlCub'].value="";
                document.getElementById('cDocVlCub').style.display= "none";
              }
          break;
          case "PROCC":
              if(document.forms['frgrm']['DocCubSi'].checked==true ) {
                document.forms['frgrm']['DocVlCubSi'].checked=true;
                document.forms['frgrm']['DocVlCubNo'].checked=false;
                document.forms['frgrm']['cDocVlCub'].value="";
                document.getElementById('cDocVlCub').style.display= "block";
                document.forms['frgrm']['cDocCub'].value="";
                document.getElementById('cDocCub').style.display= "block";
                document.forms['frgrm']['DocProXSi'].checked=true;
                document.forms['frgrm']['DocProXNo'].checked=false;
              }else{
                document.forms['frgrm']['DocVlCubSi'].checked=false;
                document.forms['frgrm']['DocVlCubNo'].checked=true;
                document.forms['frgrm']['cDocCub'].value="";
                document.getElementById('cDocCub').style.display= "none";
                document.forms['frgrm']['DocProXSi'].checked=false;
                document.forms['frgrm']['DocProXNo'].checked=true;
                document.forms['frgrm']['cDocVlCub'].value="";
                document.getElementById('cDocVlCub').style.display= "none";
              }
          break;
          case "PROVC":
            if(document.forms['frgrm']['DocVlCubSi'].checked==true ) {
              document.forms['frgrm']['DocCubSi'].checked=true;
              document.forms['frgrm']['DocCubNo'].checked=false;
              document.forms['frgrm']['cDocVlCub'].value="";
              document.getElementById('cDocVlCub').style.display= "block";
      ...
      function f_Verificar(xIdCond){
        if(document.getElementById('c'+xIdCond)){
          if(document.forms['frgrm'][xIdCond+'Si'].checked==true){
            ...
            if(xIdCond == 'DocHre') {
              if(document.forms['frgrm']['cApl'+xIdCond].value == "NO"){
                document.getElementById('c'+xIdCond).style.display = "none";
                document.getElementById('cDocHrea').style.display  = "none";
                document.forms['frgrm']['c'+xIdCond].value = "1";
                document.forms['frgrm']['cDocHrea'].value  = "1";
              }else{
                document.getElementById('cDocHrea').style.display= "block";
              }
            }
            if(xIdCond == 'DocMts3') {
              document.getElementById('cDocInt').style.display= "block";
            }
          }
          if(document.forms['frgrm'][xIdCond+'Si'].checked==false){
            ...
            if(xIdCond == 'DocHre') {
              document.getElementById('cDocHrea').style.display= "none";
              document.forms['frgrm']['cDocHrea'].value="";
            }
            if(xIdCond == 'DocMts3') {
              document.getElementById('cDocInt').style.display= "none";
              document.forms['frgrm']['cDocInt'].value="";
            }
          }
        }
      }
        ...
        for (x=0;x<document.forms['frgrm'].elements.length;x++) {
          if (document.forms['frgrm'].elements[x].type == 'radio') {
            ...
            if(document.forms['frgrm'].elements[x].id == (cNomCam+"Si")) {
              ...
              if(cNomCam == 'DocHre'){
                if (document.getElementById('cDocHre')) {
                  document.getElementById('cDocHrea').style.display= "none";
                  document.forms['frgrm']['cDocHrea'].value="";
                }
              }
              if(cNomCam == 'DocMts3'){
                if (document.getElementById('cDocMts3')) {
                  document.getElementById('cDocInt').style.display= "none";
                  document.forms['frgrm']['cDocInt'].value="";
                }
              }
      ...
      function f_Links(xLink,xSwitch) {
        ...
        switch (xLink) {
          case "cDocId":
            if (xSwitch == "VALID") {
              var cRuta  = "frddi121.php?gWhat=VALID&gFunction=cDocId&gDocNro="+document.forms['frgrm']['cDocId'].value.toUpperCase();
              ...
              var cRuta  = "frddi121.php?gWhat=WINDOW&gFunction=cDocId&gDocNro="+document.forms['frgrm']['cDocId'].value.toUpperCase();
          ...
          case "cTerNomInt":
            if (xSwitch == "VALID") {
              var cRuta = "frddiint.php?gModo="+xSwitch+"&gFunction="+xLink+
      ...
      function f_Guardar(){
        if(document.forms['frgrm']['DocHreSi'].checked==true && document.forms['frgrm']['cPreAsi'].value == "SI" && document.forms['frgrm']['cDocHrea'].value == "") {
          var cMsj = "";
          cMsj  = "El Sistema Detecto Precintos para el DO ";
          cMsj += document.forms['frgrm']['cSucId'].value + "-" + document.forms['frgrm']['cDocId'].value + "-" + document.forms['frgrm']['cDocSuf'].value;
          cMsj += " y no hay Horas de Reconocimiento Adicionales para Cobrarlos como Reconocimiento de Mercancia, ";
          cMsj += "esta Seguro de Continuar?";
          if (confirm(cMsj)) {
            document.forms['frgrm'].target = 'fmpro';
            document.forms['frgrm'].action = 'frddigra.php';
      ...
      function f_CargarTarifasFacturaA(){
        ...
        document.forms['frgrm'].action = 'frddinue.php';
        document.forms['frgrm'].submit();
      }
    </script>
  </head>
	<body>
    <form name = "frgrm" action = "frddigra.php" method = "post" target="fmpro">
      ...
      <input type="hidden" name="cAplDocHre" value="SI">
      ...
      <center>
        <table width="700" cellspacing="0" cellpadding="0" border="0"><tr><td>
          <fieldset>
            ...
            $vDatos['doctipxx'] = "IMPORTACION"; //Tipo de operación IMPORTACION, EXPORTACION, TRANSITO u OTROS
...
function f_CargaData($xDoiId,$xSucId,$xDocSuf,$xTerIdInt) {
  ...
  $vDatos['moduloxx'] = "IMPORTACION"; //Modulo
