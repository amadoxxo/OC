    ...
    <LINK rel = "stylesheet" href = "<?php echo $cSystem_Libs_JS_Directory ?>/overlib.css">
      ...
      function f_Prende_Check(xCondi){
        ...
        switch (xCondi) {
          ...
          break;
          case "PRO":
              if(document.forms['frgrm']['DocProSi'].checked==true ) {
          ...
          case "PROCC":
              if(document.forms['frgrm']['DocCuBSi'].checked==true ) {
                ...
                document.forms['frgrm']['cDocCuB'].value="";
                document.getElementById('cDocCuB').style.display= "block";
                document.forms['frgrm']['DocProSi'].checked=true;
                document.forms['frgrm']['DocProNo'].checked=false;
              }else{
                document.forms['frgrm']['DocVlCubSi'].checked=false;
                document.forms['frgrm']['DocVlCubNo'].checked=true;
                document.forms['frgrm']['cDocCuB'].value="";
                document.getElementById('cDocCuB').style.display= "none";
                document.forms['frgrm']['DocProSi'].checked=false;
                document.forms['frgrm']['DocProNo'].checked=true;
                document.forms['frgrm']['cDocVlCub'].value="";
                document.getElementById('cDocVlCub').style.display= "none";
              }
          break;
      ...
      function f_Links(xLink,xSwitch) {
        ...
        switch (xLink) {
          ...
          case "cTerNomInt":
            if (xSwitch == "VALID") {
              var cRuta = "frcdeint.php?gModo="+xSwitch+"&gFunction="+xLink+
        ...
        document.forms['frgrm'].action = 'frcdegra.php';
        document.forms['frgrm'].submit();
  	  }

  	  function f_CargarTarifasFacturaA(){
        document.forms['frgrm'].target = 'fmwork';
        document.forms['frgrm'].action = 'frcdenue.php';
        document.forms['frgrm'].submit();
      }
	  </script>
  </head>
	<body>
		<form name = "frgrm" action = "frcdegra.php" method = "post" target="fmpro">
      ...
      <center>
        <table width="700" cellspacing="0" cellpadding="0" border="0"><tr><td>
          <fieldset>
            ...
            $vDatos['doctipxx'] = "EXPORTACION"; //Tipo de operación IMPORTACION, EXPORTACION, TRANSITO u OTROS
...
function f_CargaData($xDoiId,$xSucId,$xDocSuf,$xTerIdInt) {
  ...
  $vDatos['moduloxx'] = "EXPORTACION"; //Modulo
