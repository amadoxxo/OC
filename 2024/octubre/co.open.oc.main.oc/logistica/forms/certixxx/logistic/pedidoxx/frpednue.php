    ...
    <script languaje = "javascript">
      ...
      function fnAddNewRowCertificacionAuto(xTabla, cTipoAccion = '') {
        ...
        if (nIncluir == 0) {
          ...
          var cCcoFvD     = 'cCcoFvD_Certi'   + nSecuencia; // Fecha Vigencia Desde (Oferta Comercial)
          var cCcoFvH     = 'cCcoFvH_Certi'   + nSecuencia; // Fecha Vigencia Hasta (Oferta Comercial)
          ...
          TD_xAll.innerHTML    = "<input type = 'hidden' name = '"+cCcoFvD+"'>";

          TD_xAll = cTableRow.insertCell(15);
          TD_xAll.innerHTML    = "<input type = 'hidden' name = '"+cCcoFvH+"'>";
      ...
      function fnAddNewRowCertificacionManual(xTabla, cTipoAccion = '') {
        ...
        if (nIncluir == 0) {
          ...
          TD_xAll = cTableRow.insertCell(18);
          TD_xAll.innerHTML    = "<input type = 'hidden' name = '"+cCcoFvH+"'>";

          TD_xAll = cTableRow.insertCell(19);
          TD_xAll.style.width  = "20px";
          if ('<?php echo $_COOKIE['kModo'] ?>' != "VER") {
            TD_xAll.innerHTML    = "<input type = 'button' style = 'width:020;text-align:center' name = "+oBtnDel+" id = "+oBtnDel+" value = 'X' "+
      ...
      function fnAddNewRowDetalleCerticacion(xTabla, cTipoAccion = '') {
        ...
        if (nIncluir == 0) {
          ...
          var nCerIndex   = 'nCerIndex'      + nSecuencia; // Estatus del servicio en la certificacion (Oculto)
          var cCerDetId   = 'cCerDetId'      + nSecuencia; // Id del detalle de la certificacion (Oculto)
          ...
          TD_xAll = cTableRow.insertCell(2);
          TD_xAll.innerHTML    = "<input type = 'hidden' name = '"+nCerIndex+"'>";

          TD_xAll = cTableRow.insertCell(3);
          TD_xAll.innerHTML    = "<input type = 'hidden' name = '"+cCerDetId+"'>";
      ...
      function fnCargarGrillaSubServicio() {
        ...
        var cRuta = "frpedgri.php?gCliId="+document.forms['frgrm']['cCliId'].value+
                                ...
                                "&gPedAnio="+document.forms['frgrm']['cAnio'].value+
                                "&gTipo=1";
          ...
          if (confirm("Realmente Desea Eliminar La Secuencia ["+ xSecuencia +"]?")){ 
            if(xSecuencia < nLastRow){
              ...
              for(var i=xSecuencia;i<nLastRow;i++){
                ...
                document.forms['frgrm']['cCcoFvD_Certi' + i].value     = document.forms['frgrm']['cCcoFvD_Certi' + j].value;
                document.forms['frgrm']['cCcoFvH_Certi' + i].value     = document.forms['frgrm']['cCcoFvH_Certi' + j].value;
              }
            }
          ...
          if (confirm("Realmente Desea Eliminar La Secuencia ["+ xSecuencia +"]?")){ 
            if(xSecuencia < nLastRow){
              ...
              for(var i=xSecuencia;i<nLastRow;i++){
                ...
                document.forms['frgrm']['cSec_Det'    + i].value    = i;
                document.forms['frgrm']['cCSeId_Det' + i].value     = document.forms['frgrm']['cCSeId_Det' + j].value;
                document.forms['frgrm']['nCerIndex' + i].value      = document.forms['frgrm']['nCerIndex' + j].value;
                document.forms['frgrm']['cCerDetId' + i].value      = document.forms['frgrm']['cCerDetId' + j].value;
                ...
                document.forms['frgrm']['cCebCod_Det' + i].value    = document.forms['frgrm']['cCebCod_Det' + j].value;
            ...
            // Recalcula el campo de Valor del Pedido
            fnCalTotal();
          }
        }
      }
          ...
          case "3":
            ...
            if (xTipoPedido == "AUTOMATICA") {
              for(var i=1;i<=document.forms['frgrm']['nSecuencia_Cert'].value;i++){
                ...
                // Valida que la fecha de vigencia de la oferta comercial este vigente
                var dFechIni   = new Date(document.forms['frgrm']['cCcoFvD_Certi' + i].value);
                var dFecFin    = new Date(document.forms['frgrm']['cCcoFvH_Certi' + i].value);
                var dFecActual = new Date();

                if (dFecActual < dFechIni || dFecActual > dFecFin) {
                  cMjs += "La fecha de vigencia de la Oferta Comercial no esta vigente. Secuencia ["+i+"],\n";
                }
              }
            }
      ...
      function fnCalTotal() {
        ...
        for (let n = 1; n <= parseInt(document.forms['frgrm']['nSecuencia_Det'].value); n++) {
          ...
          if (document.forms['frgrm']['cVlrPedido_Det'+n].value != "") {
            var nValor = document.forms['frgrm']['cVlrPedido_Det'+n].value;
            nValor     = nValor.replaceAll(",", "");

            if (parseFloat(nValor) > 0) {
              nTotPedido = nTotPedido + parseFloat(nValor);
            }
          }
        }

        var nVlrPedido = fnNumberFormat(nTotPedido.toFixed(2));
        document.forms['frgrm']['nTotPedido'].value = nVlrPedido;
      }

      /**
       * Permite formatear un numero con separador de miles y decimales.
       */
      function fnNumberFormat(number){
        var exp = /(\d)(?=(\d{3})+(?!\d))/g;
        var rep = '$1,';
            ...
            <form name = "frgrm" action = "frpedgra.php" method = "post" target="fmpro">
              ...
              <fieldset>
                  ...
                  <center>
                    <table border="0" cellpadding="0" cellspacing="0" width="1200">
                      ...
                      <tr>
                        ...
                        <td Class = "name" colspan = "6">Fecha Creaci&oacute;n<br>
                          <input type = "text" style = "width:120;text-align:center" name = "dComFec" value = "<?php echo date('Y-m-d') ?>" readonly>
                          <script language="javascript">
                            document.forms['frgrm']['dComFec'].value = "<?php echo date('Y-m-d') ?>";
                          </script>
                        </td>
                      </tr>
								    </table>
                ...
                <fieldset id="fieldset_de_Detalle_Certificaciones">
                  <legend><b>Relaci&oacute;n de Servicios</b></legend>
                  <center>
                    <table border = "0" cellpadding = "0" cellspacing = "0" width = "1200">
                      <?php $cCols = f_Format_Cols(60); echo $cCols; ?>
                      <tr>
          ...
          if (mysql_num_rows($xDetPedido) > 0) {
            ...
            while ($xDP = mysql_fetch_array($xDetPedido)) { 
              ...
              if ('<?php echo $vPedido['pedtipxx'] ?>' == "AUTOMATICA") {
                ...
                <?php 
                $nIncluir = 0;
                // Identifica el cambio de certificación para incluir una nueva grilla
                if ($xDP['ceridxxx'] != 0 && $xDP['ceranoxx'] != "" && ($cCerId != $xDP['ceridxxx'] || $cCerAnio != $xDP['ceranoxx'])) {
                  $nIncluir = 1;
                  $nIndexCerti++;
                  $cCerId   = $xDP['ceridxxx'];
                  $cCerAnio = $xDP['ceranoxx'];
                }
              ...
              if ($xDP['sersapxx'] != "" && $xDP['subidxxx'] != "") { 
                ...
                document.forms['frgrm']['nCerIndex'+'<?php echo $nCountDet3 ?>'].value      = '<?php echo $nIndexCerti ?>';
                ...
                document.forms['frgrm']['cBase_Det'+'<?php echo $nCountDet3 ?>'].value      = '<?php echo number_format($xDP['pedbasex'], 2, '.', ',') ?>';
                document.forms['frgrm']['cTarifa_Det'+'<?php echo $nCountDet3 ?>'].value    = '<?php echo number_format($xDP['pedtarix'], 2, '.', ',') ?>';
                document.forms['frgrm']['cCalculo_Det'+'<?php echo $nCountDet3 ?>'].value   = '<?php echo number_format($xDP['pedcalcu'], 2, '.', ',') ?>';
                document.forms['frgrm']['cMinima_Det'+'<?php echo $nCountDet3 ?>'].value    = '<?php echo number_format($xDP['pedminix'], 2, '.', ',') ?>';
                document.forms['frgrm']['cVlrPedido_Det'+'<?php echo $nCountDet3 ?>'].value = '<?php echo number_format($xDP['pedvlrxx'], 2, '.', ',') ?>';
                <?php
              }
            } ?>
            // Almacena el valor total del Pedido
            document.forms['frgrm']['nTotPedido'].value = '<?php echo number_format($nTotPedido, 2, '.', ',') ?>';
            <?php
          }
          ?>
        </script>
