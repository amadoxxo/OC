<?php
  ...
  $qSysProbg .= "pbatinxx = \"REPORTECONSOLIDADO\" ";
      ...
      function fnGenerar() {
        if (document.forms['frgrm']['dDesde'].value != "" && document.forms['frgrm']['dHasta'].value != "") {
          var cRuta = "frctrrcg.php?gEstTari="  +document.forms['frgrm']['cEstTari'].value+
                                  ...
                                  "&cEjProBg=NO";
                                  // "&cEjProBg="  +document.forms['frgrm']['cEjProBg'].value; TODO: Descomentar
        ...
        <table width="540" cellspacing="0" cellpadding="0" border="0"><tr><td>
          <fieldset>
            ...
            <table border = '0' cellpadding = '0' cellspacing = '0' width='540'>
              ...
              <tr>
                <td Class = "name" colspan = "5"><br><label>Concepto Cobro:</label></td>
                <td Class = "name" colspan = "3">
                  <a href = "javascript:document.forms['frgrm']['cSerId'].value  = '';
                                        ...
                                        f_Links('cSerId','WINDOW')" id="lSerId">C&oacute;digo</a><br>
                ...
                <td Class = "name" colspan = "17">Decripci&oacute;n<br>
              ...
              <tr>
                <td Class = "name" colspan = "5"><br><label>Forma Cobro:</label></td>
                <td Class = "name" colspan = "3">
                  <a href = "javascript:document.forms['frgrm']['cFcoId'].value = '';
                                        document.forms['frgrm']['cFcoDes'].value = '';
                                        f_Links('cFcoId','VALID')" id="lFcoId">C&oacute;digo</a><br>
