    ...
    <center>
      <table border ="0" cellpadding="0" cellspacing="0" width="520">
        <tr>
          <td>
            <fieldset>
              <legend>Ver Anexos</legend>
              <fieldset>
                <legend><?php echo $cLegend ?></legend>
                <span style="height: 2;">
                  <?php 
                    if($nTotAne > 0) {
                      echo "Total de documentos anexos: ".$nTotAne;
                    } else {
                ...
                <center>
                  ...
                  <?php if($nTotAne > 0) { ?>
                    ...
                    <tr bgcolor = '#D6DFF7' style="height:20px">
                      <td align="center" height="30" width ="120"><strong>Tipo Documental</strong></td>
                      <td align="center" height="30" width ="330"><strong>Archivo</strong></td>
                    ...
                    while ($xRAN = mysql_fetch_array($xAnexos)) {
                      ...
                      <tr bgcolor = "<?php echo $cColor ?>" onmouseover="javascript:uRowColor(this,'<?php echo $vSysStr['system_row_select_color_ini'] ?>')"
                        ...
                        <td align="center" style="padding:2px" height="30" width ="120"><?php echo $xRAN['anextdox'] ?></td>
                        <td style="padding:2px;word-break: break-all; word-wrap: break-word;" height="30" width ="330">
