														...
														<?php while ($xPD = mysql_fetch_array($xPaiDes)) {
															if (mysql_num_rows($xPaiDes) > 1) { ?>
  															...
  															<?php
  																...
  																?>
  																	<td width = "050" class= "name">
  																		<a href = "javascript:window.opener.document.forms['frgrm']['cPaiId1'].value  ='<?php echo $xPD['PAIIDXXX']?>';
  																													window.opener.document.forms['frgrm']['cPaiDes1'].value ='<?php echo $xPD['PAIDESXX']." "."(".$xPD['PAIIDNXX'].")"?>';
  																													close()"><?php echo $xPD['PAIIDXXX'] ?></a></td>
  																	<td width = "050" class= "name"> <?php echo $xPD['PAIIDNXX'] ?></td>
  																	<td width = "350" class= "name"> <?php echo $xPD['PAIDESXX'] ?></td>
  																	<td width = "050" class= "name"> <?php echo $xPD['REGESTXX'] ?></td>
  																...
  																break;
    																...
    																switch ($gFunction) {
      																...
      																<script languaje="javascript">
      																	...
      																	window.opener.document.forms['frgrm']['cPaiDes'].value = '<?php echo $xPD['PAIDESXX']." "."(".$xPD['PAIIDNXX'].")" ?>';
      																	// window.opener.f_Valida_Pais("<?php echo $xPD['PAIIDXXX'] ?>","cPaiId");
      																	close();
      																</script>
      															 <?php
      															   break;
      															...
      															?>
      																<script languaje="javascript">
      																	window.opener.document.forms['frgrm']['cPaiId1'].value  = '<?php echo $xPD['PAIIDXXX'] ?>';
      																	window.opener.document.forms['frgrm']['cPaiDes1'].value = '<?php echo $xPD['PAIDESXX']." "."(".$xPD['PAIIDNXX'].")" ?>';
      																	// window.opener.f_Valida_Pais("<?php echo $xPD['PAIIDXXX'] ?>","cPaiId1");
      																	close();
      																</script>
                                    <?php
                                    break;
	  									...
	  									<?php	} else {
	  										f_Mensaje(__FILE__,__LINE__,"No se Encontraron Registros");
	  										 ?>
	  										 <script languaje="javascript">
													window.fmwork.document.forms['frgrm']['cPaiId'].value  = "";
													close();
												 </script>
	  										 <?php
	  									}
	  									...
	  									if ($xPaiDes && mysql_num_rows($xPaiDes) > 0) {
	  										...
	  										?>
													<script languaje = "javascript">
														...
														// parent.fmwork.f_Valida_Pais("<?php echo $xPD['PAIIDXXX'] ?>","cPaiId");
														close();
													</script>
	      	      				<?php
	      	      				    break;
  	      	      				case "cPaiId1":
  	  										?>
  													<script languaje = "javascript">
  														parent.fmwork.document.forms['frgrm']['cPaiId1'].value  = '<?php echo $xPD['PAIIDXXX'] ?>';
  														parent.fmwork.document.forms['frgrm']['cPaiDes1'].value = '<?php echo $xPD['PAIDESXX']." "."(".$xPD['PAIIDNXX'].")" ?>';
  														// parent.fmwork.f_Valida_Pais("<?php echo $xPD['PAIIDXXX'] ?>","cPaiId1");
  														close();
  													</script>
  	      	      				<?php
  	      	      				  break;
												...
												<script languaje = "javascript">
												  parent.fmwork.document.forms['frgrm']['cPaiId'].value  = "";
