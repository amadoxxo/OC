        ...
        if (count($mCodDat) > 0) {
          ...
          switch($cAlfa){
            ...
            case "TETRLXXXXX"://TRLXXXXX
              $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma.jpg',11,97,35,10);
            break;
            case "ADIMPEXX":
            case "DEADIMPEXX":
            case "TEADIMPEXX":
            ...
            case "DEANDINOSX":
            case "TEANDINOSX":
              $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoandinos.jpg', 11, 96, 37, 15);
            break;
            ...
            break;
            default://Logo open
              $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/opentecnologia.JPG',17,96,25,15);
            break;
          }
