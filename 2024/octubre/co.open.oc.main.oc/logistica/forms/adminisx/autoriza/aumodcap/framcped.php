                              ...
                              for ($i=0; $i < count($mDatos); $i++) {
                                if (mysql_num_rows($xPedCab) > 1) { ?>
                                  <tr>
                                    <td width = "100" class= "name">
                                      <a href = "javascript:window.opener.document.forms['frgrm']['cPedComCsc'+'<?php echo $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['comidxxx']."-".$mDatos[$i]['comprexx']."-".$mDatos[$i]['comcscxx'] ?>';
                                ...
                                <?php
                                  ...
                                  <script language="javascript">
                                    window.opener.document.forms['frgrm']['cPedComCsc'+'<?php echo $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['comidxxx']."-".$mDatos[$i]['comprexx']."-".$mDatos[$i]['comcscxx'] ?>';
                                    window.opener.document.forms['frgrm']['cPedIds'   +'<?php echo $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['pedidxxx'] ?>';
                                    window.opener.document.forms['frgrm']['cAnio'  +'<?php echo $gSecuencia ?>'].value = '<?php echo substr($mDatos[$i]['comfecxx'], 0, 4) ?>';
                                    window.close();
                                  </script>
                        ...
                        if (count($mDatos) > 0){
                          if (count($mDatos) == 1){
                            for ($i=0; $i<count($mDatos); $i++) { 
                              ?>
                              <script language = "javascript">
                                parent.fmwork.document.forms['frgrm']['cPedComCsc'+'<?php echo $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['comidxxx']."-".$mDatos[$i]['comprexx']."-".$mDatos[$i]['comcscxx'] ?>';
