...
<html>
  <head>
    ...
    <script language="javascript">
      ...
      function fnMarca() { //Marca y Desmarca los registros seleccionados en la tabla de Conceptos de Cobro
      ...
      function fnAddNewRow() {
        ...
        TD_xAll.style.border = "1px solid #E6E6E6";
        TD_xAll.innerHTML = "<input type = 'text' class = 'letra' style = 'width:200px;border:0;text-align:center;padding:2px'  name = '"+cCliId+"' id = '"+cCliId+"' " +
        ...
        TD_xAll.style.border = "1px solid #E6E6E6";
        TD_xAll.innerHTML = "<input type = 'text' class = 'letra' style = 'width:440px;border:0;text-align:center;padding:2px' name = '" + cCliNom + "' id = '" + cCliNom + "' " + 
                                    "onBlur = 'javascript:fnLinks(\"cCliNom\", \"VALID\", \""+nSecuencia+"\");' >";

        TD_xAll = cTableRow.insertCell(5);
        TD_xAll.style.width = "240px";
        TD_xAll.style.border = "1px solid #E6E6E6";
        TD_xAll.innerHTML = "<input type='text' class='letra' style='width:240px;border:0;text-align:center;padding:2px' name='" + cCerComCsc + "' id='" + cCerComCsc + "' onBlur='javascript:this.value=this.value.toUpperCase();fnLinks(\"cCerComCsc\",\"VALID\",\"" + nSecuencia + "\")'>" +
        ...
        TD_xAll.innerHTML = "<input type = 'button' style = 'width:020px;text-align:center' id = " + nSecuencia + " value = 'X' " + "onClick = 'javascript:fnDeleteRow(this.value,\"" + nSecuencia + "\",\"Grid\", this);'>";

        document.forms['frgrm']['nSecuencia'].value = nSecuencia;
      }

      function fnAddNewRowIp(xId, xRow, xChek) {
          ...
          if (confirm("Realmente Desea Eliminar La Secuencia [" + xSecuencia + "]?")) {
            if (xSecuencia < nLastRow) {
              ...
              for (var i = xSecuencia; i < nLastRow; i++) {
                ...
                document.forms['frgrm']['cCerComCsc' + i].value = document.forms['frgrm']['cCerComCsc' + j].value;
                document.forms['frgrm']['vCerIds' + i].value    = document.forms['frgrm']['vCerIds' + j].value;
                document.forms['frgrm']['vAnio' + i].value      = document.forms['frgrm']['vAnio' + j].value;
              }
            }
      ...
      function fnMostraruOcultarObjetos(xStep) {
  ...
  <body topmargin=0 leftmargin=0 margnwidth=0 marginheight=0 style='margin-right:0'>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' width='1160'>
                          ...
                          <tr height="25px">
                            ...
                            <td bgcolor="<?php echo $vSysStr['system_row_title_color_ini'] ?>" class="clase08" colspan="02" align="right">
                              <img src="<?php echo $cPlesk_Skin_Directory ?>/btn_create-dir_bg.gif" onClick="javascript:fnAddNewRow()" style="cursor:pointer" title="Agregar">
                    ...
                    <center>
                      <table border='0' cellpadding='0' cellspacing='0' width='1160'>
                        ...
                        <tr height="25px">
                          ...
                          <td bgcolor="<?php echo $vSysStr['system_row_title_color_ini'] ?>" class="clase08" colspan="01" align="left"><input type="checkbox" name="nCheckAll" onClick="javascript:fnMarca()"></td>
                        </tr>
                      </table>
        ...
        case "1": ?>
          <table border="0" cellpadding="0" cellspacing="0" id='bnt_Paso1' width="1160">
            <tr>
              ...
              <td width="91" height="21" Class="name" background="<?php echo $cPlesk_Skin_Directory ?>/siguiente.gif" style="cursor:pointer" onClick="javascript:fnValida();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Siguiente
              </td>
              <td width="91" height="21" Class="name" background="<?php echo $cPlesk_Skin_Directory ?>/btn_cancel_bg.gif" style="cursor:hand" onClick="javascript:fnRetorna();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Salir
              </td>
            </tr>
          </table>
        <?php
        ...
        case "2": ?>
          <table border="0" cellpadding="0" cellspacing="0" id='bnt_Paso2' width="1160">
            <tr>
              ...
              <td width="91" height="21" Class="name" background="<?php echo $cPlesk_Skin_Directory ?>/anterior.gif" style="cursor:pointer" onClick="javascript:fnVolverAtras();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Anterior</td>
    ...
    <script languaje="javascript">
      fnMostraruOcultarObjetos("<?php echo $_POST['cStep'] ?>");
    </script>
    <?php
    if ($_POST['cStep'] == "2") {
      ...
      for ($i = 0; $i < count($mDataDetalles); $i++) {
        ...
        <script languaje="javascript">
          fnAddNewRowIp("<?php echo $cId ?>", "<?php echo count($mDataDetalles) ?>", "<?php echo $mDataDetalles[$i]['excluida'] ?>");
