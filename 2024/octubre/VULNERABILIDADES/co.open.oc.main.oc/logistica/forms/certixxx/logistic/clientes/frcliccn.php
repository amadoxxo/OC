<?php
  namespace openComex;
/**
* Creacion y/o Actualizacion de clientes desde un txt delimintado por tabulaciones.
* --- Descripcion: Creacion y/o Actualizacion de clientes desde un txt delimintado por tabulaciones.
...
$qSysProbg .= "pbatinxx = \"CARGARCLIENTES\" ";
...
<html>
  <head>
    ...
    <script languaje = 'javascript'>
      ...
      function fnGuardar() {
        document.forms['frgrm'].action = "frcliccg.php";
                      ...
                      <table border = "0" cellpadding = "0" cellspacing = "0" width="500">
                        ...
                        <tr>
                          <td Class="letra" colspan="25"><br>
                            ...
                            Si el archivo excel fue generado desde el Reporte Clientes, debe eliminar las columnas de color Rojo.<br><br>
                          </td>
                        </tr>
                        <tr id="EjProBg">
