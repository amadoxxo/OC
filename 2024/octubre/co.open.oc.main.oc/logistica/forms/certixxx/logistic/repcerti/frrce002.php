                          ...
                          <center>
                            <table cellspacing = "0" cellpadding = "1" border = "1" width = "500">
                              <tr bgcolor = '#D6DFF7'>
                                ...
                                <td width = "350" Class = "name"><center>Descripci&oacute;</center></td>
                                  ...
                                  if (mysql_num_rows($xOfiVenta) > 1) { ?>
                                    <tr>
                                      <td width = "100" class= "name">
                                          <a href = "javascript:window.opener.document.forms['frgrm'].cOfvSap.value = '<?php echo $xROV['ofvsapxx']?>';
                                                                window.opener.document.forms['frgrm'].cOfvDes.value = '<?php echo $xROV['ofvdesxx']?>';
                                                                window.opener.fnLinks('cOfvSap','EXACT',0);
                                    ...
                                    <script languaje="javascript">
                                      window.opener.document.forms['frgrm'].cOfvSap.value = "<?php echo $xROV['ofvsapxx'] ?>";
                                      window.opener.document.forms['frgrm'].cOfvDes.value = "<?php echo $xROV['ofvdesxx'] ?>";
                                      window.opener.fnLinks('cOfvSap', 'EXACT', 0);
                                      window.close();
                                    </script>
                          ...
                          if (mysql_num_rows($xOfiVenta) == 1){
                            while ($xROV = mysql_fetch_array($xOfiVenta)) { 
                              ...
                              <script language = "javascript">
                                ...
                                parent.fmwork.fnLinks('cOfvSap','EXACT',0);
                              </script>
                            <?php }
                          }else{ ?>
                            <script language = "javascript">
