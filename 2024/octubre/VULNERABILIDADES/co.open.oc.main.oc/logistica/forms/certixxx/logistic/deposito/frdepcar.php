<?php
  ...
  /**
  * Cargar Deposito.
  * --- Descripcion: Creacion y/o Actualizacion de desposutos desde un txt delimintado por tabulaciones.
  ...
  */
  ...
  $qSysProbg .= "pbatinxx = \"CARGARDEPOSITO\" ";
...
<html>
  <head>
    ...
    <script languaje = 'javascript'>
      ...
      function fnGuardar() {
        document.forms['frgrm'].action = "frdepcag.php";
  ...
  <body topmargin = "0" leftmargin = "0" margnwidth = "0" marginheight = "0" style = "margin-right:0">
    ...
    <center>
      <table border ="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <form name = "frgrm" enctype='multipart/form-data' action = "frdepcag.php" method = "post" target="fmpro">
