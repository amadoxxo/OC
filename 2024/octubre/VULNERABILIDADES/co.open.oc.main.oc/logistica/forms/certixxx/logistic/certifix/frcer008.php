                                  ...
                                  if (mysql_num_rows($xCanalDist) > 1) { ?>
                                    <tr>
                                      <td width = "100" class= "name">
                                          <a href = "javascript:window.opener.document.forms['frgrm'].cCdiSap.value  = '<?php echo $xRCD['cdisapxx']?>';
                                                                window.opener.document.forms['frgrm'].cCdiDes.value = '<?php echo $xRCD['cdidesxx']?>';
                                                                window.opener.fnLinks('cCdiSap','EXACT',0);
                                    ...
                                    <script languaje="javascript">
                                      window.opener.document.forms['frgrm'].cCdiSap.value  = "<?php echo $xRCD['cdisapxx'] ?>";
                                      window.opener.document.forms['frgrm'].cCdiDes.value = "<?php echo $xRCD['cdidesxx'] ?>";
                                      window.opener.fnLinks('cCdiSap', 'EXACT', 0);
                                      window.close();
                                    </script>
                        ...
                        if (mysql_num_rows($xCanalDist) > 0){
                          if (mysql_num_rows($xCanalDist) == 1){
                            while ($xRCD = mysql_fetch_array($xCanalDist)) { 
                              ...
                              ?>
                              <script language = "javascript">
                                parent.fmwork.document.forms['frgrm'].cCdiSap.value  = "<?php echo $xRCD['cdisapxx'] ?>";
                                parent.fmwork.document.forms['frgrm'].cCdiDes.value = "<?php echo $xRCD['cdidesxx'] ?>";
                                parent.fmwork.fnLinks('cCdiSap','EXACT',0);
                              </script>
                            <?php }
                          }else{ ?>
                            <script language = "javascript">
                          ...
                          <script language = "javascript">
                            ...
                            parent.fmwork.document.forms['frgrm'].cCdiSap.value  = "";
                            parent.fmwork.document.forms['frgrm'].cCdiDes.value = "";
                          </script>
                          <?php
                        }
                      break;
