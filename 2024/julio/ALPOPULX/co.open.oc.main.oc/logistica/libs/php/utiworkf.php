...
class cTickets
{
  ...
  function fnEnvioEmail($nSwitch, $cMsj, $cId)
  {
    ...
    if (count($ticketEnviado) > 0) {
      ...
      $cMessage .= "<table width='100%' border='0' cellspacing='0' cellpadding='0' style='background-color: #f9f9f9; padding: 10px;'>";
      $cMessage .= "<tr>";
      $cMessage .= "<td align='center'>";
      $cMessage .= "<table width='100%' border='0' cellspacing='10' cellpadding='10' style='margin-top: 20px; margin-bottom: 5px; background-color: #EEEEEE;'>";
      $cMessage .= "<tr>";
      $cMessage .= "<td width='85%'><strong>Ticket: </strong>{$_POST['cTicket']}</td>";
      $cMessage .= "<td><strong>POST ID: </strong>{$datosCabecera[0]['repcscxx']}</td>";
      $cMessage .= "</tr>";
      $cMessage .= "<tr>";
      $cMessage .= "<td><strong>Asunto: </strong>{$_POST['cAsuTck']}</td>";
      $cMessage .= "<td><strong>Estado: </strong>{$datosCabecera['stidesxx']}</td>";
      $cMessage .= "</tr>";
      $cMessage .= "</table>";
      $cMessage .= "<tr>";
      $cMessage .= "<td>";
      $cMessage .= "<table width='100%' border='0' cellspacing='10' cellpadding='10' style='font-size: 14px; background-color: #E7F2FF;'>";
      $cMessage .= "<tr style='border-bottom: 1px solid #e5e5e5;'>";
      $cMessage .= "<td width='50%'>";
      $cMessage .= "<strong>Cliente: </strong>{$_POST['cCliId']}-{$_POST['cCliNom']}";
      $cMessage .= "</td>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Certificaci&oacute;n: </strong>{$datosCabecera['comidxxx']}-{$datosCabecera['comprexx']}{$datosCabecera['comcscxx']}";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "<tr style='border-bottom: 1px solid #e5e5e5;'>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Enviado a: </strong>".implode(', ', $ticketEnviado);
      $cMessage .= "</td>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>CC a: </strong>{$_POST['cCliPCECn']}";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "<tr style='border-bottom: 1px solid #e5e5e5;'>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Tipo de Ticket: </strong>{$datosCabecera['ttidesxx']}";
      $cMessage .= "</td>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Prioridad: </strong>{$datosCabecera['ptidesxx']}";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "<tr style='border-bottom: 1px solid #e5e5e5;'>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Fecha de Creaci&oacute;n: </strong>{$datosCabecera['regfcrex']}";
      $cMessage .= "</td>";
      $cMessage .= "<td>";
      $cMessage .= "<strong>Cierre Ticket: </strong>{$cTiCcErx}";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "</table>";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "<tr>";
      $cMessage .= "<td style='text-align: left; font-size: 14px; padding: 20px; background-color: #ffffff;'><br><br>{$_POST['cConten']}</td>";
      $cMessage .= "</tr>";
      $cMessage .= "</td>";
      $cMessage .= "</tr>";
      $cMessage .= "</table>";
