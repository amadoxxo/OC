    ...
    function fnEviarEmailSMTP($pArrayDatos) {
      ...
      */
      ...
      for ($i=0; $i < count($pArrayDatos['destinos']); $i++){
        if (!preg_match('/^[^0-9][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_.-]+)*[@][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,}$/',trim($pArrayDatos['destinos'][$i]))) {
          $nSwitch = 1;
      ...
      for ($i=0; $i < count($pArrayDatos['destincc']); $i++){
        if (!preg_match('/^[^0-9][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_.-]+)*[@][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,}$/',trim($pArrayDatos['destincc'][$i]))) {
          $nSwitch = 1;
      ...
      for ($i=0; $i < count($pArrayDatos['replytox']); $i++){
        if (!preg_match('/^[^0-9][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_.-]+)*[@][a-zA-Z0-9_.-]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,}$/',trim($pArrayDatos['replytox'][$i]))) {
          $nSwitch = 1;
        ...
        switch ($pArrayDatos['basedato']) {
          ...
          default:
            ...
            try {
              ...
              $mail->SetFrom("prueba@correo.com", "$cEtiqueta");
