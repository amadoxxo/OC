<?php
	...
	/**
	 * Nuevo Descuento 
	 * --- Descripcion: Permite Crear Nuevo Descuento
				...
				<tr>
					<td>
						<fieldset>
							...
							<form name = "frnav" action = "frdesgra.php" method = "post" target = "fmpro">
									...
									<table border = "0" cellpadding = "0" cellspacing = "0" width="400">
										...
										<tr>
											<td Class = "name" colspan = "2">
												...
												<input type = "text" Class = "letra" style = "width:040;text-align:center" name = "cSerId" id="cSerId"
											...
											<td Class = "name" colspan = "18">Servicio<br>
												<input type = "text" Class = "letra" style = "width:360" name = "cSerDes" readonly>
											</td>
										</tr>
										<tr>
											<td Class = "name" colspan = "2">
												<a href = "javascript:document.forms['frnav']['cFcoId'].value  = '';
																							document.forms['frnav']['cFcoDes'].value = '';
																							fnLinks('cFcoId','VALID')" id="lFcoId">Id</a><br>
												<input type = "text" Class = "letra" style = "width:040;text-align:center" name = "cFcoId"
													onBlur = "javascript:this.value=this.value.toUpperCase();
																							fnLinks('cFcoId','VALID');
																							this.style.background='<?php echo $vSysStr['system_imput_onblur_color'] ?>'"
													onFocus="javascript:document.forms['frnav']['cFcoId'].value  = '';
																							document.forms['frnav']['cFcoDes'].value = '';
																							this.style.background='<?php echo $vSysStr['system_imput_onfocus_color'] ?>'">
											</td>
											<td Class = "name" colspan = "18">Forma de Cobro<br>
												<input type = "text" Class = "letra" style = "width:360" name = "cFcoDes" readonly>
											</td>
										</tr>
										<tr>
											<td Class = "name" colspan = "4">C&oacute;digo<br>
												<input type = "text" Class = "letra" name = "cDesCod" style = "width:80" maxlength="10"
													onFocus= "javascript:this.style.background='#00FFFF'";
													onblur = "javascript:this.value=this.value.toUpperCase();
																							this.style.background='#FFFFFF'">
											</td>
											<td Class = "name" colspan = "16">Descuento %<br>
												<input type = "text" Class = "letra" name = "cDesPorc" style = "width:320"
													onFocus= "javascript:this.style.background='#00FFFF';"
													onblur = "javascript:this.value=this.value.toUpperCase();
																							this.style.background='#FFFFFF'">
											</td>
