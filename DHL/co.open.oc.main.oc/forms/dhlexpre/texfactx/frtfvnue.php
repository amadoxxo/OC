<?php
/**
 * Formulario de Texto Factura de Venta DHL.
 * Descripcion: Permite Crear solo una vez un registro de Texto Factura de Venta DHL,
 ...
 */
  ...
  <html>
    ...
    <center>
      <table border ="0" cellpadding="0" cellspacing="0" width="700">
        <tr>
          <td>
            <fieldset>
              <legend>Texto Factura de Venta DHL</legend>
              <form name = "frgrm" action = "frtfvgra.php" method = "post" target = "fmpro">
                <center>
                  <table border = "0" cellpadding = "0" cellspacing = "0" width="700">
                  <?php echo f_Columnas(35,20); ?>
                    <tr>
                      <td Class = "name" colspan = "35">T&iacute;tulo<br>
                        <input type = "text" Class = "letra" name = "cTfvTitu" style = "width:700" maxlength="150"
                    ...
                    <tr>
                      <td Class = "name" colspan = "35"><br>Contenido <b style="color:red;">(Recuerde para separar los p&aacute;rrafos (enter) se deber&aacute; incluir //)</b><br>
                        <textarea name="cTfvCont" rows="3" style = "width:700; height:100; "
                                  onFocus="javascript:this.style.background='#00FFFF';"
    ...
    <center>
      <table border="0" cellpadding="0" cellspacing="0" width="700">
        <tr height="21"> 
          ...
          <td id='botonGuardar' width="91" height="21" Class="name" background="<?php echo $cPlesk_Skin_Directory_New ?>/btn_ok_bg.gif" style="cursor:pointer"
    ...
    function fnVerficarCargueData() {
       ...
       */
      $qTexNotC  = "SELECT * ";
      $qTexNotC .= "FROM $cAlfa.zdex0011 LIMIT 0,1";
      ...
      if (mysql_num_rows($xTexNotC) == 1) {
        ...
        <script language = "javascript">
          document.forms['frgrm']['cTfvTitu'].value = "<?php echo str_replace(array('"',"'"),array('\"',"\'"),$vTexNotC['tfvtitxx']) ?>";
          document.forms['frgrm']['cTfvCont'].value = "<?php echo str_replace(array('"',"'"),array('\"',"\'"),$vTexNotC['tfvcontx']) ?>";
