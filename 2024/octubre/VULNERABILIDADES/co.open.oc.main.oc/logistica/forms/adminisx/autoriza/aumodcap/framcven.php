                        ...
                        <center>
                          <table border = "0" cellpadding = "0" cellspacing = "0" width = "560">
                            <tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
                              ...
                              <td class = "clase08" width = "280" style="padding-left:5px;padding-right:5px" align = "center">Servicio</td>
                              <td class = "clase08" width = "200" style="padding-left:5px;padding-right:5px" align = "center">Subservicio</td>
