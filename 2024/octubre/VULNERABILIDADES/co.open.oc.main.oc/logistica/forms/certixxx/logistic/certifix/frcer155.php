                                      ...
                                      <td width = "050" class= "name">
                                          <a href = "javascript:window.opener.document.forms['frgrm']['cDepNum'].value = '<?php echo $xRDE['depnumxx']?>';
                                                                if ('<?php echo $gOrigen ?>' == 'NUEVO') {
                                                                  window.opener.document.forms['frgrm']['cDepNum_hidd'].value = '<?php echo $xRDE['depnumxx']?>';
                                                                  window.opener.document.forms['frgrm']['cTipoDep'].value = '<?php echo $xRDE['tdedesxx']?>';
                                                                  window.opener.document.forms['frgrm']['cOrvSap'].value  = '<?php echo $xRDE['orvsapxx']?>';
                                                                  window.opener.document.forms['frgrm']['cOrvDes'].value  = '<?php echo $xRDE['orvdesxx']?>';
                                                                  window.opener.document.forms['frgrm']['cOfvSap'].value  = '<?php echo $xRDE['ofvsapxx']?>';
                                                                  window.opener.document.forms['frgrm']['cOfvDes'].value  = '<?php echo $xRDE['ofvdesxx']?>';
                                                                  window.opener.document.forms['frgrm']['cCloSap'].value  = '<?php echo $xRDE['closapxx']?>';
                                                                  window.opener.document.forms['frgrm']['cCloDes'].value  = '<?php echo $xRDE['clodesxx']?>';
                                                                  window.opener.document.forms['frgrm']['cSecSap'].value  = '<?php echo $xRDE['secsapxx']?>';
                                                                  window.opener.document.forms['frgrm']['cSecDes'].value  = '<?php echo $xRDE['secdesxx']?>';
                                                                }
                          ...
                          if (mysql_num_rows($xDeposito) == 1){
                            while ($xRDE = mysql_fetch_array($xDeposito)) { 
                              ...
                              <script language = "javascript">
                                ...
                                if ('<?php echo $gOrigen ?>' == 'NUEVO') {
                                  parent.fmwork.document.forms['frgrm']['cDepNum_hidd'].value = "<?php echo $xRDE['depnumxx'] ?>";
                      ...
                      case "EXACT":
                        ...
                        if (mysql_num_rows($xDeposito) > 0) {
                          ...
                          <script language = "javascript">
                            ...
                            if ('<?php echo $gOrigen ?>' == 'NUEVO') {
                              parent.fmwork.document.forms['frgrm']['cDepNum_hidd'].value = "<?php echo $vDeposito['depnumxx'] ?>";
                              parent.fmwork.document.forms['frgrm']['cTipoDep'].value = '<?php echo $vDeposito['tdedesxx'] ?>';
                              parent.fmwork.document.forms['frgrm']['cOrvSap'].value  = '<?php echo $vDeposito['orvsapxx'] ?>';
                              parent.fmwork.document.forms['frgrm']['cOrvDes'].value  = '<?php echo $vDeposito['orvdesxx'] ?>';
                              parent.fmwork.document.forms['frgrm']['cOfvSap'].value  = '<?php echo $vDeposito['ofvsapxx'] ?>';
