...
<html>
	<head>
  	<LINK rel = 'stylesheet' href = '<?php echo $cSystem_Libs_JS_Directory ?>/estilo.css'>
   	...
   	<script language="javascript">
    	...
    	function f_Ver(xBanId) {
      	var ruta = "frbannue.php?cBanId="+xBanId;
      	document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	document.cookie="kMenDes=Ver Banco;path="+"/";
				...
				switch (document.forms['frgrm']['vRecords'].value) {
					case "1":
						if (document.forms['frgrm']['oChkCom'].checked == true) {
							...
							var ruta = "frbannue.php?cBanId="+zMatriz[0];
      	      document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	      document.cookie="kMenDes=Editar Banco;path="+"/";
				 ...
				 if (document.forms['frgrm']['vRecords'].value!="0"){
  				switch (document.forms['frgrm']['vRecords'].value) {
  					case "1":
  						if (document.forms['frgrm']['oChkCom'].checked == true) {
   						  var zMatriz = document.forms['frgrm']['oChkCom'].id.split('-');
   						  if (confirm("Esta Seguro de Cambiar el Estado del Banco No. "+zMatriz[0]+" ?")) {
									document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
    							document.forms['frestado']['cBanId'].value=zMatriz[0];
  ...
  <body topmargin = "0" leftmargin = "0" rightmargin = "0" bottommargin = "0" marginheight = "0" marginwidth = "0">
		<form name = "frestado" action = "frbangra.php" method = "post" target="fmpro">
			<input type = "hidden" name = "cBanId" value = "">
      ...
      <?php
        ...
        $qDatBan  = "SELECT * ";
				...
				$qDatBan .= "ORDER BY regfmodx DESC,reghmodx DESC";
				$xDatBan  = f_MySql("SELECT","",$qDatBan,$xConexion01,"");

				/* Cargo la Matriz con los ROWS del Cursor */
				$i=0;
				while ($mDatBan = mysql_fetch_array($xDatBan)) {
					$zMatrizTmp[$i] = $mDatBan;
					$i++;
				}
	        ...
	        for ($i=0,$j=0;$i<count($zMatrizTmp);$i++) {
	          ...
	          $cCadena  = $zMatrizTmp[$i]['banidxxx']."~";
	          $cCadena .= $zMatrizTmp[$i]['bandesxx']."~";
      ...
      <center>
       	<table width="95%" cellspacing="0" cellpadding="0" border="0">
         	<tr>
	       	  <td>
				      <fieldset>
   			        <legend>Bancos del Periodo Seleccionado (<?php echo count($zMatrizTra)?>)</legend>
     	         	<center>
     	       		...
     	       		<center>
         	         	...
         	         	<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
         	         		<td class="name" width="10%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','banidxxx','ASC_NUM')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','banidxxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','banidxxx','')">Id</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "banidxxx">
           	         		<script language="javascript">f_ButtonsAscDes('','banidxxx','')</script>
           	         	</td>
           	         	<td class="name" width="40%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','bandesxx','ASC_AZ')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','bandesxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','bandesxx','')">Banco</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "bandesxx">
           	         		<script language="javascript">f_ButtonsAscDes('','bandesxx','')</script>
           	         	</td>
 	                    ...
 	                    <?php for ($i=intval($vLimInf);$i<intval($vLimInf+$vLimSup);$i++) {
 	                    	if ($i < count($zMatrizTra)) { // Para Controlar el Error
	                   	    ...
	                   	    if($y % 2 == 0) {
		                      	...
		                      	<td class="letra7" width="10%"><a href = javascript:f_Ver('<?php echo $zMatrizTra[$i]['banidxxx']?>')><?php echo $zMatrizTra[$i]['banidxxx'] ?></a></td>
	       	                	<td class="letra7" width="40%"><?php echo $zMatrizTra[$i]['bandesxx'] ?></td>
	            	            ...
	            	            <td Class="letra7" width="02%" align="right"><input type="checkbox" name="oChkCom"  value = "<?php echo count($zMatrizTra) ?>"
	                   	    		id="<?php echo $zMatrizTra[$i]['banidxxx'].'-'.$zMatrizTra[$i]['regestxx']?>"
