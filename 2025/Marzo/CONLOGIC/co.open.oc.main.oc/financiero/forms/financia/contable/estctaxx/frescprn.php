						...
						<?php if ($nFilCta > 0 OR mysql_num_rows($xEstPro) > 0) {
                            ...
                            <?php break;
														...
														case "TEHAYDEARX": //HAYDEARX ?>
															<td rowspan="2" class="name" width="100%">
																<center>
																	<img width="100" height="45" style="left: 18px;margin-top: 4px;margin-left:10px;position: absolute;" src="<?php echo $cPlesk_Skin_Directory ?>/logohaydear.jpeg">
																	<br><span style="font-size:14px;font-weight:bold">DE CUENTA POR <?php echo $cTipoCta ?></span><br>
																	<?php echo $cMes . " " . substr($fec, 8, 2) . " DE " . substr($fec, 0, 4) ?>
																</center><br>
															</td>
														...
														case "TECONNECTA": //CONNECTA ?>
															<td rowspan="2" class="name" width="100%">
																<center>
																	<img width="80" height="50" style="left: 18px;margin-top: 4px;margin-left:10px;position: absolute;" src="<?php echo $cPlesk_Skin_Directory ?>/logoconnecta.jpg">
																	<br><span style="font-size:14px;font-weight:bold">DE CUENTA POR <?php echo $cTipoCta ?></span><br>
																	<?php echo $cMes . " " . substr($fec, 8, 2) . " DE " . substr($fec, 0, 4) ?>
																</center><br>
															</td>
              ...
              $cMsj .= "No se encontraron registros.";
				...
				case 3 :
                  ...
                  break;
									...
									case "DEHAYDEARX": //HAYDEARX
									case "TEHAYDEARX": //HAYDEARX
										$this->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logohaydear.jpeg',14,8,50,13.5);
									break;
									case "CONNECTA":   // CONNECTA
									case "DECONNECTA": // CONNECTA
									case "TECONNECTA": // CONNECTA
                  ...
                  case "DECONLOGIC";
                  case "TECONLOGIC";
                    $this->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoconlogic.jpg',14,8,20,13.5);
                  break;
									case "OPENEBCO":   // OPENEBCO
									case "DEOPENEBCO": // OPENEBCO
									case "TEOPENEBCO": // OPENEBCO
