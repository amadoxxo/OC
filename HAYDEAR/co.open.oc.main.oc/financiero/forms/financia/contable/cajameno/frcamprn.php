      ...
      $qCmeDat .= "LEFT JOIN $cAlfa.SIAI0003 ON $cAlfa.fcme$cAno.regusrxx = $cAlfa.SIAI0003.USRIDXXX ";
          ...
          // # DE PAGINAS //
                ...
                case "TETRLXXXXX": //TRLXXXXX
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma.jpg',20,6,20,19);
                break;
								case "TEADIMPEXX":
								case "DEADIMPEXX":
								case "ADIMPEXX":
          ...
          $pdf->Cell(15,3,'$'.number_format($totalcr,0,',','.'),0,0,'R');
  		  ...
  		  if ($nFilCme > 0) {
	          ...
	          if ($P == 1 || (($P % 25) == 0))	{
                ...
                case "DETRLXXXXX": //TRLXXXXX
                case "TETRLXXXXX": //TRLXXXXX
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma.jpg',20,$py+1,20,19);
                break;
								case "TEADIMPEXX":
								case "DEADIMPEXX":
								case "ADIMPEXX":
                ...
                break;
								...
								case "DEHAYDEARX":
								case "TEHAYDEARX":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logohaydear.jpeg',14,$py+4,36,16);
								break;
								default://Logo open
