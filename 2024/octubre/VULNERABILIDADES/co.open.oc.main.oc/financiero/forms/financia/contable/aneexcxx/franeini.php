				 ...
				 case "cTerId":
					case "cTerNom":
					  if (xLink == "cTerId" || xLink == "cTerNom") {
						...
						if (xSwitch == "VALID") {
							var cPathUrl = "frane150.php?gModo="+xSwitch+"&gFunction="+xLink+
																				"&gTerTip="+cTerTip+
																				"&gTerId="+cTerId+
																				"&gTerNom="+cTerNom;
							//alert(cPathUrl);
    				   ...
    				   band == 0){ 
		        		var zX      = screen.width;
		      			...
		      			var ancho = zX-100;
		       			...
		       			var zRuta = "frtsaexc.php?gSucId="+document.forms['frgrm']['cSucId'].value+
	...
	<body topmargin = 0 leftmargin = 0 margnwidth = 0 marginheight = 0 style = 'margin-right:0'>
		<center>
            ...
            <form name='frgrm' action='frtsaexc.php' method="POST">
              <center>
          	    <fieldset>
          		    <legend>Anexo Factura Pagos a Terceros y Servicios </legend>
          		    <table border="2" cellspacing="0" cellpadding="0" width="">
          		     	<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>' style="heigth:25">
          			     	<td class="name" width="30%"><center><h5><br>ANEXO FACTURA PAGOS A TERCEROS Y SERVICIOS</h5></center></td>
          			    </tr>
          			  </table>
          			  <table border = '0' cellpadding = '0' cellspacing = '0' width='520'>
                ...
                <center>
          				<table border="0" cellpadding="0" cellspacing="0" width="520">
            				<tr height="21">
            					...
            					<td width="91" height="21" Class="name" background="<?php echo $cPlesk_Skin_Directory ?>/btn_ok_bg.gif" style="cursor:hand" onClick = 'javasript:f_Anexo_Factura_Excel()'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Generar</td>
