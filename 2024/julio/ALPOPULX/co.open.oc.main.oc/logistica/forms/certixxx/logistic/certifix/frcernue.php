  ...
  <head>
    ...
    <script languaje = "javascript">
      ...
      function fnAddNewRowServicio(xTabla) {
        ...
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:300;text-align:left' name = '"+cSerDescri+"' id = '"+cSerDescri+"' onKeydown = 'javascript:if(event.keyCode == 13){ fnLinks(\"cSerSap\",\"VALID\",\""+nSecuencia+"\") }' >";
        ...
        TD_xAll.style.width  = "300px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:300;text-align:left' name = '"+cSubDescri+"' id = '"+cSubDescri+"' onKeydown = 'javascript:if(event.keyCode == 13){ fnLinks(\"cSubId\",\"VALID\",\""+nSecuencia+"\") }'>";
        ...
        TD_xAll.style.width  = "300px";
        TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:300;text-align:left' name = '"+cUnidadDes+"' id = '"+cUnidadDes+"' onKeydown = 'javascript:if(event.keyCode == 13){ fnLinks(\"cUfaId\",\"VALID\",\""+nSecuencia+"\") }'>";
                ...
                <center>
                  <table border="0" cellpadding="0" cellspacing="0" width="980">
                    ...
                    <tr>
                      ...
                      <td class="clase08" colspan="6">Consecutivo<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cComCsc" maxlength="6"
                      ...
                      <td class="clase08" colspan="3">Hora<br>
                        <input type = "text" Class = "letra" style = "width:60;text-align:center" name="tComHCre" readonly value = "<?php echo date('H:i:s') ?>" readonly>
                      </td>
                      <td class="clase08" colspan="7">Tipo Certificaci&oacute;n<br>
                        <select Class = "letrase" name = "cCerTip" style = "width:140" onChange = "javascript:fnCambiaTipoCertificacion(this.value);">
                    ...
                    <!-- Fila 2 -->
                    <tr>
                      <td class = "clase08" colspan="4">A&ntilde;o<br>
                      ...
                      <td Class="clase08" colspan="6">M.I.F<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cMifComCsc"
                      ...
                      <input type = "hidden" name = "cAnioMif" value = "">

                      <td class = "clase08" colspan = "6">Consecutivo 2<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cMifComCsc2" value = "<?php echo $cMifComCsc2 ?>" readonly>
                      </td>
                      <td class = "clase08" colspan = "6">
                        <a id="id_href_dVigDesde" href='javascript:show_calendar("frgrm.dVigDesde")'>Vigencia Desde</a><br>
                        <input type="text" name="dVigDesde" style = "width:120;height:15;text-align:center">
                      </td>
                      <td class = "clase08" colspan = "6">
                        <a href='javascript:show_calendar("frgrm.dVigHasta")' id="id_href_dVigHasta">Vigencia Hasta</a><br>
                        <input type="text" name="dVigHasta" style = "width:120;height:15;text-align:center">
                      </td>
                      <td class="clase08" colspan="1"><br>
                      ...
                      <td class="clase08" colspan="5">
                        <a href = "javascript:document.forms['frgrm']['cDepNum'].value      = '';
                                              document.forms['frgrm']['cDepNum_hidd'].value = '';
                                              document.forms['frgrm']['cTipoDep'].value     = '';
                                              fnLinks('cDepNum','VALID')" id = "id_href_DepNum">Dep&oacute;sito</a><br>
                        <input type = "text" Class = "letra" style = "width:100" name = "cDepNum" maxlength="20"
                      ...
                      <input type = "hidden" name = "cDepNum_hidd" value = "">
                      <input type = "hidden" name = "cCcoIdOc" value = "">
                      <td class = "clase08" colspan="11">Tipo Deposito<br>
                        <input type = "text" Class = "letra" style = "width:220" name = "cTipoDep" readonly>
                      </td>
                    </tr>

                    <!-- Fila 3 -->
                    <tr>
                      <td class="clase08" colspan="6">C&oacute;digo SAP<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cOrvSap" readonly>
                      </td>
                      <td class = "clase08" colspan="10">Organizaci&oacute;n de Venta<br>
                        <input type = "text" Class = "letra" style = "width:200" name = "cOrvDes" readonly>
                      </td>
                      <td class="clase08" colspan="1"><br>
                        <input type = "text" Class = "letra" style = "width:20;" readonly>
                      </td>
                      <td class="clase08" colspan="6">C&oacute;digo SAP<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cOfvSap" readonly>
                      </td>
                      <td class = "clase08" colspan="9">Oficina de Venta<br>
                        <input type = "text" Class = "letra" style = "width:180" name = "cOfvDes" readonly>
                      </td>
                      <td class="clase08" colspan="1"><br>
                        <input type = "text" Class = "letra" style = "width:20;" readonly>
                      </td>
                      <td class="clase08" colspan="6">C&oacute;digo SAP<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cCloSap" readonly>
                      </td>
                      <td class = "clase08" colspan="10">Centro Log&iacute;stico<br>
                        <input type = "text" Class = "letra" style = "width:200" name = "cCloDes" readonly>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td class="clase08" colspan="6">C&oacute;digo SAP<br>
                        <input type = "text" Class = "letra" style = "width:120" name = "cSecSap" readonly>
                      </td>
                      <td class = "clase08" colspan="10">Sector<br>
                        <input type = "text" Class = "letra" style = "width:200" name = "cSecDes" readonly>
                      </td>
                      <td class="clase08" colspan="1"><br>
                        <input type = "text" Class = "letra" style = "width:20;" readonly>
                      </td>
                      <td class="clase08" colspan="6">
                        <a href = "javascript:document.forms['frgrm']['cCdiSap'].value  = '';
                                              document.forms['frgrm']['cCdiDes'].value = '';
                                              fnLinks('cCdiSap','VALID')" id = "id_href_CdiSap">C&oacute;digo SAP</a><br>
                        <input type = 'text' Class = 'letra' style = 'width:120' name = 'cCdiSap' maxlength="2"
                      ...
                      <td class = "clase08" colspan="9">Canal Distribuci&oacute;n<br>
                        <input type = "text" Class = "letra" style = "width:180" name = "cCdiDes"
                          onBlur = "javascript:fnLinks('cCdiDes','VALID');
                                              this.style.background='<?php echo $vSysStr['system_imput_onblur_color'] ?>'"
                          onFocus = "javascript:document.forms['frgrm']['cCdiSap'].value  = '';
                                                document.forms['frgrm']['cCdiDes'].value = '';
                                                this.style.background='<?php echo $vSysStr['system_imput_onfocus_color'] ?>'">
                      ...
                      <td class = "clase08" colspan="16">Tipo de Mercanc&iacute;a<br>
                        <input type = "text" Class = "letra" style = "width:320" name = "cCerTipMe" maxlength="50">
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td Class = "clase08" colspan="49">
                        <fieldset id = "serviciosManual">
                          <legend>Datos de Servicios a Certificar</legend>
                          <table border = '0' cellpadding = '0' cellspacing = '0' width='940'>
                            <?php $nCol = f_Format_Cols(47); echo $nCol;?>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class = "clase08" colspan="15" align="center">Servicio</td>
                              <td class = "clase08" colspan="15" align="center">Subservicio</td>
                              <td class = "clase08" colspan="15" align="center">Unidad Facturable</td>
                              <td class = "clase08" colspan="01" align="right">&nbsp;</td>
                            </tr>
                          </table>
                          <table border = "0" cellpadding = "0" cellspacing = "0" width = "940" id = "Grid_Servicios"></table>
                        </fieldset>
                      </td>
                    </tr>

                    <!-- Servicios - AUTOMATICO -->
                    <tr>
                      <td Class = "clase08" colspan="49">
                    ...
                    <!-- Observacion -->
                    <tr>
                      <td Class = "clase08" colspan = "49"><br>
                        <fieldset>
                          <legend>Observaciones</legend>
                          <textarea class="letrata" name="cCerObs" style="width:950;height:35;" onblur="javascript:this.value=this.value.toUpperCase();">
                          </textarea>
                        </fieldset>
                      </td>
                    </tr>
