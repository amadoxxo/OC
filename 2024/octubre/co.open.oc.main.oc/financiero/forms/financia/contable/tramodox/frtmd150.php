	  								...
	  								case "VALID":
	  									...
	  									switch ($gFunction) {
	  										case "cTerId":
													...
													$qDatExt .= "ORDER BY CLIIDXXX LIMIT 0,1";
	  										break;
	  										case "cTerNom":
	  										...
	  										$vDatExt = mysql_fetch_array($xDatExt); ?>
												<script languaje = "javascript">
												  switch ("<?php echo $gFunction ?>") {
												    case "cTerId":
												    case "cTerNom":
                              parent.fmwork.document.forms['frnav']['cTerId'].value  = "<?php echo $vDatExt['CLIIDXXX'] ?>";
    													parent.fmwork.document.forms['frnav']['cTerDV'].value  = "<?php echo f_Digito_Verificacion($vDatExt['CLIIDXXX']) ?>";
                              parent.fmwork.document.forms['frnav']['cTerNom'].value = "<?php echo $cNombre = ($vDatExt['CLINOMXX'] != "") ? $vDatExt['CLINOMXX'] : trim($vDatExt['CLIAPE1X']." ".$vDatExt['CLIAPE2X']." ".$vDatExt['CLINOM1X']." ".$vDatExt['CLINOM2X']); ?>";
												    break;
												  }
												</script>
  										<?php } else { ?>
																	...
																	<td width = "030" Class = "name">
																		<a href = "javascript:
															                   switch ('<?php echo $gFunction ?>') {
															                     case 'cTerId':
												                           case 'cTerNom':
                      															 window.opener.document.forms['frnav']['cTerId'].value  = '<?php echo $xRDE['CLIIDXXX'] ?>';
                      															 window.opener.document.forms['frnav']['cTerDV'].value  = '<?php echo f_Digito_Verificacion($xRDE['CLIIDXXX']) ?>';
																										 window.opener.document.forms['frnav']['cTerNom'].value = '<?php echo $cNombre = ($xRDE['CLINOMXX'] != "") ? $xRDE['CLINOMXX'] : trim($xRDE['CLIAPE1X']." ".$xRDE['CLIAPE2X']." ".$xRDE['CLINOM1X']." ".$xRDE['CLINOM2X']); ?>';
																									 break;
															                   }
                                  ...
                                  <td width = "050" Class = "name"><center><?php echo $xRDE['REGESTXX'] ?></center></td>
		 									...
		 									<?php	} else {
												...
												<script languaje="javascript">
												    ...
												    case "cTerId":
												    case "cTerNom":
															window.opener.document.forms['frnav']['cTerId'].value  = "";
															window.opener.document.forms['frnav']['cTerDV'].value  = "";
															window.opener.document.forms['frnav']['cTerNom'].value = "";
														break;
													}
													window.close();
												</script>
