    ...
    function fnCrearTablasAnualizadas() {
      ...
      if($nSwitch == 0){
        ...
        if (mysql_num_rows($xTabExis) == 0) {
          ...
          if (!$xCreate) {
            $nSwitch = 1;
            $vReturn[count($vReturn)] = __LINE__."~Error al crear Tabla Anualizada.";
          } else {
            ...
            if (!$xAlter) {
              $nSwitch = 1;
              $vReturn[count($vReturn)] = __LINE__."~Error al crear FK Anualizada.";
            }
            ...
            if( mysql_num_rows($xTabExis) == 0 ){
              ...
              if(!$xCreate) {
                $nSwitch = 1;
                $mReturn[count($mReturn)] = "Error al crear Tabla Anualizada.";
              } else {
                /**
                ...
                if (!$xAlter) {
                  $nSwitch = 1;
                  $vReturn[count($vReturn)] = __LINE__."~Error al crear FK Anualizada [lpde$nAnio].";
                }
              }
            } 
          }  
