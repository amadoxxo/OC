    ...
    class PDF_AutoPrint extends PDF_Javascript{
      ...
      function Header() {        
        ...
        if (in_array($vCocDat['terid2xx'], $vNitsAdq)) {
          $this->Ln(4.5);
          $this->setX($posx);
          $this->Cell(15,5,utf8_decode("Ciudad Prestación Servicio: ") . $cSucDes,0,0,'L');
        }
				$this->Ln(4.5);
				$this->setX($posx);
        ...
        $this->Cell(15,5,utf8_decode("Regimen Común de IVA"),0,0,'R');
				$this->Ln(4.5);
				$this->setX($posx+165);
				$this->Cell(15,5,utf8_decode("Actividad Económica No. 6201 ICA 9,66"),0,0,'R');
				$this->Ln(4.5);
