                                  ...
                                  if (mysql_num_rows($xTipoDep) > 1) { ?>
                                    <tr>
                                      <td width = "100" class= "name">
                                          <a href = "javascript:window.opener.document.forms['frgrm'].cTdeId.value  = '<?php echo $xRTD['tdeidxxx']?>';
                                                                window.opener.document.forms['frgrm'].cTdeDes.value = '<?php echo $xRTD['tdedesxx']?>';
                                                                window.opener.fnLinks('cTdeId','EXACT',0);
                                    ...
                                    <script languaje="javascript">
                                      window.opener.document.forms['frgrm'].cTdeId.value  = "<?php echo $xRTD['tdeidxxx'] ?>";
                                      window.opener.document.forms['frgrm'].cTdeDes.value = "<?php echo $xRTD['tdedesxx'] ?>";
                                      window.opener.fnLinks('cTdeId', 'EXACT', 0);
                                      window.close();
                                    </script>
                        ...
                        if (mysql_num_rows($xTipoDep) > 0){
                          if (mysql_num_rows($xTipoDep) == 1){
                            while ($xRTD = mysql_fetch_array($xTipoDep)) { 
                              ...
                              ?>
                              <script language = "javascript">
                                parent.fmwork.document.forms['frgrm'].cTdeId.value  = "<?php echo $xRTD['tdeidxxx'] ?>";
                                parent.fmwork.document.forms['frgrm'].cTdeDes.value = "<?php echo $xRTD['tdedesxx'] ?>";
                                parent.fmwork.fnLinks('cTdeId','EXACT',0);
                              </script>
                            <?php }
                          }else{ ?>
                            <script language = "javascript">
                          ...
                          <script language = "javascript">
                            ...
                            parent.fmwork.document.forms['frgrm'].cTdeId.value  = "";
                            parent.fmwork.document.forms['frgrm'].cTdeDes.value = "";
                          </script>
                          <?php
                        }
                      break;
