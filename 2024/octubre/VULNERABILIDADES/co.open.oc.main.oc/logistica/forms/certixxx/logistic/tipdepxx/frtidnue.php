...
/**
 * Tipo de Depósito.
 * --- Permite Crear un Nuevo Tipo de Depósito.
        ...
        <tr>
          <td>
            <fieldset>
              ...
              <form name = 'frgrm' action = 'frtidgra.php' method = 'post' target='fmpro'>
                <center>
                    <table border = '0' cellpadding = '0' cellspacing = '0' width='460'>
                      ...
                      <tr>
                        <td Class = 'clase08' colspan = '6'>ID<br>
                          <input type = "text" Class = "letra" style = 'width:120' name = 'cTdeId' onBlur = "javascript:this.value=this.value.toUpperCase()" maxlength="2">
                        </td>
                        <td Class = 'clase08' colspan = '17'>Tipo de Dep&oacute;sito<br>
                          <input type = "text" Class = "letra" style = 'width:340' name = 'cTdeDes' onBlur = "javascript:this.value=this.value.toUpperCase()" maxlength="255">
                        </td>
                      </tr>
                      <tr>
...
switch ($_COOKIE['kModo']) {
  ...
  case "EDITAR":
    ...
    ?>
    <script languaje = "javascript">
      document.forms['frgrm']['cTdeId'].readOnly	 = true;
    </script>
  <?php break;
  case "VER":
    fnCargaData($cTdeId); ?>
...
<?php function fnCargaData($xTdeId) {
  ...
  $qTipDep .= "WHERE ";
  $qTipDep .= "tdeidxxx = \"$xTdeId\" LIMIT 0,1";
  ...
  ?>
  <script language = "javascript">
    document.forms['frgrm']['cTdeId'].value = "<?php echo $vTipDep['tdeidxxx'] ?>";
    document.forms['frgrm']['cTdeDes'].value = "<?php echo $vTipDep['tdedesxx'] ?>";
    document.forms['frgrm']['dFecCre'].value = "<?php echo $vTipDep['regfcrex'] ?>";
    document.forms['frgrm']['dHorCre'].value = "<?php echo $vTipDep['reghcrex'] ?>";
    document.forms['frgrm']['dFecMod'].value = "<?php echo $vTipDep['regfmodx'] ?>";
    document.forms['frgrm']['dHorMod'].value = "<?php echo $vTipDep['reghmodx'] ?>";
    document.forms['frgrm']['cEstado'].value = "<?php echo $vTipDep['regestxx'] ?>";
  </script>
  <?php
} ?>
