<?php
	/**
	* Cargar Facturas Provisionales desde un txt delimitado por tabulaciones.
	* --- Descripcion: Cargar Facturas Provisionales desde un txt delimitado por tabulaciones.
  ...
  $dHoy = date('Y-m-d');
	...
	$qSysProbg .= "pbatinxx = \"CARGARFACTURASPROVISIONALES\" ";
  ...
  ?>
	<head>
      ...
      function fnDescargar(xArchivo){
  	  ...
  	  function fnGuardar() {
        document.forms['frgrm']['kModo'].value = "";
  	  	document.forms['frgrm'].action = "frfaccfg.php";
			  document.forms['frgrm'].submit();
  	  }
  	  
  	  function fnDownLoad() {
  	  	document.forms['frgrm']['kModo'].value = "EXCEL";
			  document.forms['frgrm'].submit();
  	  }
		</script>
	</head>
	<body topmargin = "0" leftmargin = "0" margnwidth = "0" marginheight = "0" style = "margin-right:0">
		...
		<center>
			<table border ="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<form name = "frgrm" enctype='multipart/form-data' action = "frfaccfg.php" method = "post" target="fmpro">
							<input type="hidden" name="kModo" value="">
							<table border ="0" cellpadding="0" cellspacing="0">
								<tr>
									<td>
										<fieldset>
                        ...
                        <tr id="EjProBg">
                          <td Class = "name" colspan = "25">
                            <label><input type="checkbox" name="cEjProBg" value ="SI" onclick="javascript:this.checked = true; this.value = 'SI'" checked>Ejecutar Proceso en Background</label>
                          </td>
                        </tr>
											</table>
										</fieldset>
