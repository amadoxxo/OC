                                  ...
                                  <tr>
                                    <td width = "050" class= "name">
                                      <a href = "javascript:window.opener.document.forms['frgrm']['cCerId'+'<?php echo $gGrid . $gSecuencia ?>'].value     = '<?php echo $mDatos[$i]['ceridxxx']?>';
                                                            window.opener.document.forms['frgrm']['cCerComCsc'+'<?php echo $gGrid . $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['comidxxx']."-".$mDatos[$i]['comprexx']."-".$mDatos[$i]['comcsc2x'] ?>';
                                                            ...
                                                            window.opener.document.forms['frgrm']['cMifComCsc'+'<?php echo $gGrid . $gSecuencia ?>'].value = '<?php echo $vMifCab['comidxxx']."-".$vMifCab['comprexx']."-".$vMifCab['comcsc2x'] ?>';
                            ...
                            for ($i=0; $i < count($mDatos); $i++) { 
                              ...
                              if ($nIncluir == 1) {
                                ...
                                <script language = "javascript">
                                  ...
                                  parent.fmwork.document.forms['frgrm']['cCerComCsc'+'<?php echo $gGrid . $gSecuencia ?>'].value = '<?php echo $mDatos[$i]['comidxxx']."-".$mDatos[$i]['comprexx']."-".$mDatos[$i]['comcsc2x'] ?>';
                                  ...
                                  parent.fmwork.document.forms['frgrm']['cMifComCsc'+'<?php echo $gGrid . $gSecuencia ?>'].value = '<?php echo $vMifCab['comidxxx']."-".$vMifCab['comprexx']."-".$vMifCab['comcsc2x'] ?>';
                        ...
                        if (mysql_num_rows($xCertiCab) == 1) { 
                          ...
                          if ($nIncluir == 1) {
                            ...
                            <script language = "javascript">
                              ...
                              parent.fmwork.document.forms['frgrm']['cCerComCsc'+'<?php echo $gGrid . $gSecuencia ?>'].value = '<?php echo $vCertiCab['comidxxx']."-".$vCertiCab['comprexx']."-".$vCertiCab['comcsc2x'] ?>';
