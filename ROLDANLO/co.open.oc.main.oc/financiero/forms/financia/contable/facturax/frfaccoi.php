...
<?php
   ...
   * @author Jhon David Castillo <jhon.castillo@open-eb.co>
   * @package openComex
   */
    ...
    <script language="javascript">
      function fnEnviarDatos(){
        ...
        vDatos['cPeriodos']     = document.forms['frgrm']['cPeriodos'].value;
			  ...
			  vDatos['cEstadoDian']   = document.forms['frgrm']['cEstadoDian'].value;
        ...
        vDatos['cTerId2']       = document.forms['frgrm']['cTerId2'].value;
        vDatos['cTerDV2']       = document.forms['frgrm']['cTerDV2'].value;
        vDatos['cTerNom2']      = document.forms['frgrm']['cTerNom2'].value;
            ...
            <td>
              <fieldset>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="460">
                  ...
                  <tr>
                    <td class = "name" colspan="05"><br>Ususario</td>
                    <td class = "name" colspan="18"><br>
                  ...
                  <?php if ($vSysStr['system_activar_openetl'] == "SI") { ?>
                    <tr>
                      <td class = "name" colspan="05"><br>Estado DIAN</td>
                      <td class = "name" colspan="18"><br>
                        <select Class = "letra" name = "cEstadoDian" style = "width:360">
                          <option value = "">ESTADO DIAN</option>
                          <option value = "REGISTRADO-VP">REGISTRADO (VP)</option>
                          <option value = "APROBADO">APROBADO (VP)</option>
                          <option value = "APROBADO_NOTIFICACION">APROBADO CON NOTIFICACION (VP)</option>
                          <option value = "FALLIDO-VP">CON ERRORES (VP)</option>
                          <option value = "NOENVIAR-VP">NO ENVIADO (VP)</option>
                          <option value = "NOSELECCIONAR">-------------------------</option>
                          <option value = "REGISTRADO-2242">REGISTRADO (2242)</option>
                          <option value = "EXITOSO">EXITOSO (2242)</option>
                          <option value = "RECIBIDO">RECIBIDO (2242)</option>
                          <option value = "FALLIDO-2242">CON ERRORES (2242)</option>
                          <option value = "NOENVIAR-2242">NO ENVIADO (2242)</option>
                        </select>
                        <script language = "javascript">
                          document.forms['frgrm']['cEstadoDian'].value = "<?php echo $cEstadoDian ?>";
                        </script>
                      </td>
                    </tr>
                  <?php } else { ?>
                    <tr>
                      <td class = "name" colspan="23">
                  ...
                  <tr>
                    ...
                    <td class = "name" colspan="18"><br>
                    <input type="text" class="letra" name = "cConsecutivo" value = "<?php echo $cConsecutivo ?>" style= "width:340" onblur="javascript:this.value=this.value.toUpperCase()">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class = "name" colspan="05"><br><a href = "javascript:document.forms['frgrm']['cTerId2'].value  = '';
                                              document.forms['frgrm']['cTerDV2'].value  = '';
                                              document.forms['frgrm']['cTerNom2'].value = '';
                                              f_Links('cTerId2','VALID')" id="id_href_cTerId2">Facturar a:</a>
                      </td>
                      <td class="name" colspan = "05"><br>
                        <input type="text" name="cTerId2" style = "width:100" value = "<?php echo $cTerId2 ?>"
                              onfocus="javascript:document.forms['frgrm']['cTerId2'].value  = '';
                                                  document.forms['frgrm']['cTerDV2'].value  = '';
                                                  document.forms['frgrm']['cTerNom2'].value = '';
                                                  this.style.background='#00FFFF'"
                              onBlur = "javascript:this.value=this.value.toUpperCase();
                                                  f_Links('cTerId2','VALID');
                                                  this.style.background='#FFFFFF'">
                      </td>
                      <td Class = "name" colspan = "02"><br>
                        <input type = "text" style = "width:40;text-align:center" name = "cTerDV2" value = "<?php echo $cTerDV2 ?>" readonly>
                      </td>
                      <td class="name" colspan = "10"><br>
                        <input type="text" name="cTerNom2" style = "width:200" value = "<?php echo $cTerNom2 ?>"
                              onfocus="javascript:document.forms['frgrm']['cTerId2'].value  = '';
                                                  document.forms['frgrm']['cTerDV2'].value  = '';
                                                  document.forms['frgrm']['cTerNom2'].value = '';
                                                  this.style.background='#00FFFF'"
                              onBlur = "javascript:this.value=this.value.toUpperCase();
                                                  f_Links('cTerNom2','VALID');
                                                  this.style.background='#FFFFFF'">
                      </td>
                      <td class = "name" colspan="01"><br>
                        <input type = "text" style = "width:20;text-align:center" readonly>
