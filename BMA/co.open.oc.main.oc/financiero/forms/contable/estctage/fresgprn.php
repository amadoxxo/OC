      ...
      switch ($cTipo) {
                  ...
                  <tr>
                    ...
                    switch ($cAlfa) {
                      ...
                      case "DEANDINOSX"://ANDINOSX ?>
                        <td class="name" style="font-size:14px;width:100px">
                          <img src = "<?php echo $cPlesk_Skin_Directory ?>/logoandinos.jpg" style="height: 60px;width:120">
                        </td>
                      <?php break;
        ...
        default:
          ...
          switch ($cAlfa) {
            ...
            case "DETRLXXXXX":
            case "TETRLXXXXX":
              $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma.jpg',10,11,40,13);
            break;
            ...
            case "TEANDINOSX"://ANDINOSX
            case "DEANDINOSX"://ANDINOSX
              $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoandinos.jpg', 6, 11, 29, 13);
            break;
            case "GRUPOALC"://GRUPOALC
            case "TEGRUPOALC"://GRUPOALC
            case "DEGRUPOALC"://GRUPOALC
