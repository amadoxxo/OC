...
<html>
    ...
    <script language="javascript">
      ...
      function fnLinks(xLink, xSwitch) {
        ...
        switch (xLink) {
          ...
          case "cCliNom":
            if (xSwitch == "VALID") {
              var cRuta = "frati150.php?gWhat=VALID&gFunction="+xLink+"&gCliId=" + document.forms['frgrm'][xLink].value.toUpperCase();
              parent.fmpro.location = cRuta;
            } else {
              var zNx = (nX - 600) / 2;
              var zNy = (nY - 250) / 2;
              var zWinPro = 'width=600,scrollbars=1,height=250,left=' + zNx + ',top=' + zNy;
              var cRuta = "frati150.php?gWhat=WINDOW&gFunction="+xLink+"&gCliId=" + document.forms['frgrm'][xLink].value.toUpperCase();
          ...
          case "cResNom":
            if (xSwitch == "VALID") {
              var cRuta = "frati003.php?gWhat=VALID&gFunction="+xLink+"&gUsrId=" + document.forms['frgrm'][xLink].value.toUpperCase();
              parent.fmpro.location = cRuta;
            } else {
              var zNx = (nX - 600) / 2;
              var zNy = (nY - 250) / 2;
              var zWinPro = 'width=600,scrollbars=1,height=250,left=' + zNx + ',top=' + zNy;
              var cRuta = "frati003.php?gWhat=WINDOW&gFunction="+xLink+"&gUsrId=" + document.forms['frgrm'][xLink].value.toUpperCase();
              zWindow = window.open(cRuta, "zWindow", zWinPro);
              zWindow.focus();
            }
          break;
          ...
          case "cTipDes":
            if (xSwitch == "VALID") {
              var cRuta = "frati158.php?gWhat=VALID&gFunction="+xLink+"&gTipId=" + document.forms['frgrm'][xLink].value.toUpperCase();
              parent.fmpro.location = cRuta;
            } else {
              var zNx = (nX - 600) / 2;
              var zNy = (nY - 250) / 2;
              var zWinPro = 'width=600,scrollbars=1,height=250,left=' + zNx + ',top=' + zNy;
              var cRuta = "frati158.php?gWhat=WINDOW&gFunction="+xLink+"&gTipId=" + document.forms['frgrm'][xLink].value.toUpperCase();
              zWindow = window.open(cRuta, "zWindow", zWinPro);
              zWindow.focus();
            }
          break;
          case "cCerComCsc":
            if (document.forms['frgrm']['cCerComCsc'].value != "") {
              if (document.forms['frgrm']['cCerComCsc'].value.length < 1) {
                ...
                if (xSwitch == "VALID") {
                  var cRuta = "fratiaxx.php?gModo=" + xSwitch + "&gFunction=" + xLink +
  ...
  <body>
    <form name="frgrm" action="fratiini.php" method="post" target="fmwork">
