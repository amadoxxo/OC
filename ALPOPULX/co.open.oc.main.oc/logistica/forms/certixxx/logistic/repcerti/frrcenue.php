<?php
  /**
   * Filtros Reporte Certificación.
   * --- Descripcion: Permite seleccionar los filtros para generar el Reporte de Certificación
    ...
    <form name='frgrm' action='frrceprn.php' method="POST" target="fmpro">
      <center>
        <table width="480" cellspacing="0" cellpadding="0" border="0"><tr><td>
          <fieldset>
            <legend>Consulta Certificaciones </legend>
            <table border="2" cellspacing="0" cellpadding="0" width="480">
              <tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>' style="heigth:25">
                <td class="name" width="30%"><center><h5><br>REPORTE MOVIMIENTO CERTIFICACIONES</h5></center></td>
              </tr>
            </table>
              ...
              <tr>
                <td Class = "clase08" colspan = "4">
                  <a href = "javascript:document.forms['frgrm']['cOrvSap'].value = '';
                                        ...
                                        fnLinks('cOrvSap','VALID')" id = "idOrvSap">Id</a><br>
                  <input type = 'text' Class = 'letra' style = 'width:80' name = 'cOrvSap' maxlength="2"
                    onBlur = "javascript:this.value=this.value.toUpperCase();
                ...
                <td Class = "clase08" colspan = "4">
                  <a href = "javascript:document.forms['frgrm']['cOfvSap'].value = '';
                                        document.forms['frgrm']['cOfvDes'].value = '';
                                        fnLinks('cOfvSap','VALID')" id = "idOfvSap">Id</a><br>
                  <input type = 'text' Class = 'letra' style = 'width:80' name = 'cOfvSap' maxlength="2"
                    onBlur = "javascript:this.value=this.value.toUpperCase();
                ...
                <td class = "clase08" colspan = "7">Oficina Ventas<br>
                  <input type = 'text' Class = 'letra' style = 'width:140' name = "cOfvDes"
                    onBlur = "javascript:this.value=this.value.toUpperCase();
