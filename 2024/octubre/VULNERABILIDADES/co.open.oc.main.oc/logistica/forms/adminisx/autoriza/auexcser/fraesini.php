  ...
  <head>
    ...
    <script language="javascript">
      ...
      function fnVer(xOrvSap) {
        ...
        var cPathUrl = "fraesven.php?ceridxxx="+mMatriz[0] + "&ceranoxx="+mMatriz[3] + "&cliidxxx="+mMatriz[4] + "&clinomxx="+mMatriz[5]+ "&cercscxx="+mMatriz[2];
        ...
        switch (document.forms['frnav']['nRecords'].value) {
          case "1":
            if (document.forms['frnav']['oCheck'].checked == true) {
              ...
              var cPathUrl = "fraesven.php?ceridxxx="+mMatriz[0] + "&ceranoxx="+mMatriz[3] + "&cliidxxx="+mMatriz[4] + "&clinomxx="+mMatriz[5]+ "&cercscxx="+mMatriz[2]+ "&aesobsxx="+mMatriz[6];
              document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
