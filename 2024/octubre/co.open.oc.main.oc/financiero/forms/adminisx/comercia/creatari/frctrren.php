<?php
  namespace openComex;
  /**
	 * Filtros Reporte de Tarifas.
	 * --- Descripcion: Permite seleccionar los filtros para generar el Reporte de Tarifas
  ...
  $qSysProbg .= "pbatinxx = \"REPORTETARIFAS\" ";
...
<html>
  <head>
    ...
    <script languaje = 'javascript'>
       ...
       */
      function fnGenerar() {
        if (document.forms['frgrm']['cCliId'].value != "" || (document.forms['frgrm']['dDesde'].value != "" && document.forms['frgrm']['dHasta'].value != "")) {
          var cRuta = "frctrreg.php?gEstTari="  +document.forms['frgrm']['cEstTari'].value+
          ...
          alert("Debe Seleccionar el Cliente/Grupo o un Rango de Fechas,\nVerifique.")
        }
      }

      /**
       * Habilita o deshabilita los campos de rango de fechas cuando se selecciona un Cliente o Grupo.
       */
  ...
  <body>
    <form name='frgrm' action='frctrreg.php' method="POST" target="fmpro">
      <center>
        <table width="500" cellspacing="0" cellpadding="0" border="0"><tr><td>
          <fieldset>
            <legend>Generaci&oacute;n de Reporte Tarifas </legend>
            <table border = '0' cellpadding = '0' cellspacing = '0' width='500'>
              ...
              <tr>
                <td Class = "name" colspan = "5"><br>Tarifa por:</td>
                ...
                <td Class = "name" colspan = "4">
                  <a href = "javascript:document.forms['frgrm']['cCliId'].value = '';
                                        document.forms['frgrm']['cCliNom'].value = '';
                                        document.forms['frgrm']['cCliDV'].value  = '';
                                        f_Links('cCliId','VALID')" id = "lCliId"><label id="lblCliId">Nit</label></a><br>
                ...
                <td Class = "name" colspan = "1"><label id="lblCliDv">Dv</label><br>
                  <input type = "text" Class = "letra" style = "width:020;text-align:center" name = "cCliDV" readonly>
                </td>
                <td Class = "name" colspan = "10"><label id="lblCliNom">Cliente</label><br>
              ...
              <tr>
                ...
                <td Class = "name" colspan = "6"><br>
                  <select Class = "letrase" name = "cTipoFec" style = "width:120">
                    <option value = "CREACION" selected>CREACION</option>
