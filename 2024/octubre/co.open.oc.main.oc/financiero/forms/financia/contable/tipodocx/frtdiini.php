<?php
  namespace openComex;
/**
 * Tracking tipo de Documento.
 * Este programa permite realizar consultas rapidas de los Tipos de Documentos que se Encuentran en la Base de Datos.
 * @author
 * @package emisioncero
 */
...
<html>
	<head>
  	<LINK rel = 'stylesheet' href = '<?php echo $cSystem_Libs_JS_Directory ?>/estilo.css'>
   	...
   	<script language="javascript">
    	...
    	function f_Ver(xTdiId) {
      	var ruta = "frtdinue.php?cTdiId="+xTdiId;
      	document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	document.cookie="kMenDes=Ver Tipo de Documento;path="+"/";
				...
				switch (document.forms['frgrm']['vRecords'].value) {
					case "1":
						if (document.forms['frgrm']['oChkCom'].checked == true) {
							...
							var ruta = "frtdinue.php?cTdiId="+zMatriz[0];
      	      document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	      document.cookie="kMenDes=Editar Tipo de Documento;path="+"/";
				 ...
				 if (document.forms['frgrm']['vRecords'].value!="0"){
  				switch (document.forms['frgrm']['vRecords'].value) {
  					case "1":
  						if (document.forms['frgrm']['oChkCom'].checked == true) {
   						  var zMatriz = document.forms['frgrm']['oChkCom'].id.split('-');
   						  if (confirm("Esta Seguro de Cambiar el Estado del Tipo de Documento No. "+zMatriz[0]+" ?")) {
									document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
    							document.forms['frestado']['cTdiId'].value=zMatriz[0];
  ...
  <body topmargin = "0" leftmargin = "0" rightmargin = "0" bottommargin = "0" marginheight = "0" marginwidth = "0">
		<form name = "frestado" action = "frtdigra.php" method = "post" target="fmpro">
			<input type = "hidden" name = "cTdiId" value = "">
      ...
      <?php
        ...
        $qDatTdi  = "SELECT * ";
	        ...
	        for ($i=0,$j=0;$i<count($zMatrizTmp);$i++) {
	          ...
	          $cCadena  = $zMatrizTmp[$i]['tdiidxxx']."~";
	          $cCadena .= $zMatrizTmp[$i]['tdidesxx']."~";
      ...
      <center>
       	<table width="95%" cellspacing="0" cellpadding="0" border="0">
         	<tr>
	       	  <td>
				      <fieldset>
   			        <legend>Tipo de Documento del Periodo Seleccionado (<?php echo count($zMatrizTra)?>)</legend>
     	         	<center>
     	       		...
     	       		<center>
         	         	...
         	         	<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
         	         		<td class="name" width="10%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','tdiidxxx','ASC_NUM')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','tdiidxxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','tdiidxxx','')">Id</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "tdiidxxx">
           	         		<script language="javascript">f_ButtonsAscDes('','tdiidxxx','')</script>
           	         	</td>
           	         	<td class="name" width="40%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','tdidesxx','ASC_AZ')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','tdidesxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','tdidesxx','')">Tipo de Documento</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "tdidesxx">
           	         		<script language="javascript">f_ButtonsAscDes('','tdidesxx','')</script>
           	         	</td>
 	                    ...
 	                    <?php for ($i=intval($vLimInf);$i<intval($vLimInf+$vLimSup);$i++) {
 	                    	if ($i < count($zMatrizTra)) { // Para Controlar el Error
	                   	    ...
	                   	    if($y % 2 == 0) {
		                      	...
		                      	<td class="letra7" width="10%"><a href = javascript:f_Ver('<?php echo $zMatrizTra[$i]['tdiidxxx']?>')><?php echo $zMatrizTra[$i]['tdiidxxx'] ?></a></td>
	       	                	<td class="letra7" width="40%"><?php echo $zMatrizTra[$i]['tdidesxx'] ?></td>
	            	            ...
	            	            <td Class="letra7" width="02%" align="right"><input type="checkbox" name="oChkCom"  value = "<?php echo count($zMatrizTra) ?>"
	                   	    		id="<?php echo $zMatrizTra[$i]['tdiidxxx'].'-'.$zMatrizTra[$i]['regestxx']?>"
