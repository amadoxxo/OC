<?php
  namespace openComex;
  /**
	 * Permite Eliminar y Cargar Responsabilidades Fiscales en la ficha de terceros
      ...
      if ($fl == 1) {
        ...
        if ($cCadena == "~")  {
          ...
          <script languaje = 'javascript'>
            parent.fmwork.document.forms['frgrm']['cCliResFi'].value = "<?php echo $cCadena ?>";
            parent.fmwork.fnCargarResponsabilidadFiscal();
          </script>
      <?php }
    break;
    case "5":
      if ($cCliResFi != "") {
        $vCadenaAnt = $cCliResFi;
      }
