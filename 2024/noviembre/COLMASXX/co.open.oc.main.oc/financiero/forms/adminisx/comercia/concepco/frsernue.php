		...
		<script language="javascript">
          ...
          case "cSccId":
				...
				if (e.keyCode) code = e.keyCode;
						...
						if(code==13) {
							if (xGrid == 'Grid_LineaNegocio') {
								...
								uLinks('cCodLineaNeg', 'WINDOW', nSecuencia);
							} else {
			...
			function fnAddNewRowLineaNegocio(xTabla) {
				...
				TD_xAll.style.width  = "120px";
				TD_xAll.innerHTML    = "<input type = 'text' class = 'clase08' style = 'width:120;text-align:left' name = '"+cDesLineaNeg+"' id = '"+cDesLineaNeg+"''>";
        ...
        /* Descripcion del Centro de Costo */
          ...
          <?php } ?>
              ...
              if ($mLineasNegocio[$i][0] != "") { 
								...
								document.forms['frgrm']['cDesLineaNeg' + document.forms['frgrm']['nSecuencia_Grid_LineaNegocio'].value].value = "";
