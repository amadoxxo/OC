<?php
  ...
  switch($cAlfa){
    ...
    case "DEANDINOSX": //ANDINOSX
      $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoAndinos2.jpeg', 12, 0, 15, 20);
    break;
    default:
      // No hace nada
    break;
  ...
  switch($cAlfa){
    ...
    case "DEGRUMALCO": //GRUMALCO
      $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logomalco.jpg',90,8,34,18);
      $posy = 30;
    break;
    ...
    case "TEEXPORCOM":  //EXPORCOMEX
      $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logo-Exporcomex.jpeg',90,6,40);
      $posy = 30;
    break;
    ...
    case "TEADUALOGX":
    case "DEADUALOGX":
      $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoAdualog.jpg',6,10,100,20);
      $posy = 30;
    break;
    case "CONLOGIC";
    case "DECONLOGIC";
    case "TECONLOGIC";
      $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoconlogic.jpg',90,8,30,20);
      $posy = 30;
    break;
    case "OPENEBCO":
    case "DEOPENEBCO":
    case "TEOPENEBCO":
      $pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/opentecnologia.JPG',80,10,55,20);
      $posy = 30;
    break;
		default:
      $posy = 15;
