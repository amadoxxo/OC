	  										...
	  										<center>
					    						<table cellspacing = "0" cellpadding = "1" border = "1" width ="500">
														<tr>
															...
															<td widht ="390" bgcolor="#D6DFF7" Class = "name"><center>NOMBRE</center></td>
														...
														<?php while ($zRow = mysql_fetch_array($xPucDes)) {
															if (mysql_num_rows($xPucDes) > 1) {
																...
																<tr>
																	<td style="width:060" class= "name">
																		<a href = "javascript:window.opener.document.forms['frgrm']['cPucId'].value ='<?php echo $zRow['cuentaxx']?>';
															...
															<?php	} else { ?>
																<script languaje="javascript">
																	window.opener.document.forms['frgrm']['cPucId'].value  = '<?php echo $zRow['cuentaxx'] ?>';
																	window.opener.document.forms['frgrm']['cPucDes'].value = '<?php echo $zRow['pucdesxx'] ?>';
																	window.close();
																</script>
															<?php }
	  								  ...
	  								  $xPucDes  = f_MySql("SELECT","",$qPucDes,$xConexion01,"");
	  									...
	  									if ($xPucDes && mysql_num_rows($xPucDes) > 0) {
	  										while ($zRow = mysql_fetch_array($xPucDes)) { ?>
													<script languaje = "javascript">
	      	    							parent.fmwork.document.forms['frgrm']['cPucId'].value  = '<?php echo $zRow['cuentaxx'] ?>';
