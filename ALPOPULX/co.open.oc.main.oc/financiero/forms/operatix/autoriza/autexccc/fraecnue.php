			...
			<table border ="0" cellpadding="0" cellspacing="0" width="560">
                  ...
                  document.getElementById("cComMemo").style.display ="none";
                	...
                	<legend>Datos Do</legend>
									<table border = '0' cellpadding = '0' cellspacing = '0' width='560'>
  							 		...
  							 		echo $nCol;?>
							    	<tr>
											<td class = "name" colspan = "2">Suc<br>
										 		<input type = "text" class = "letra" name = "cSucId" style = "width:40" readonly>
											</td>
								    	<td class = "name" colspan = "5">Do<br>
												<input type = "text" class = "letra" style = "width:100;text-align:left" name = "cDocId"  readonly>
										 	</td>
										 	<td class = "name" colspan = "2">Sufijo<br>
										 		<input type = "text" class = "letra" name = "cDocSuf" style = "width:40" readonly>
										 	</td>
										 	<td class = "name" colspan = "5">Tipo Operacion<br>
										 		<input type = "text" class = "letra" name = "cDocTip" style = "width:100" readonly>
										 	</td>
										 	<td class = "name" colspan = "4">Nit<br>
										 		<input type = "text" class = "letra" name = "cCliId" style = "width:80" readonly>
										 	</td>
										 	<td class = "name" colspan = "10">Cliente<br>
										 		<input type = "text" class = "letra" name = "cCliNom" style = "width:200" readonly>
										 	</td>
										</tr>
									</table>
                ...
                // f_Mensaje(__FILE__, __LINE__, $qTarifas."~".mysql_num_rows($xTarifas));
  							...
  							if(mysql_num_rows($xTarifas) > 0){
  								?>
  								<fieldset id="Tarifas">
  			  	    		<legend>Tarifas a Excluir</legend>
                  		<center>
  											<table border = "0" cellpadding = "0" cellspacing = "0" width = "560">
  												<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
  													<td class = "clase08" width = "040" style="padding-left:5px;padding-right:5px" align = "center">Id</td>
  													<td class = "clase08" width = "400" style="padding-left:5px;padding-right:5px" align = "center">Descripcion</td>
  													<td class = "clase08" width = "100" style="padding-left:5px;padding-right:5px" align = "center">Tipo Tarifa</td>
