  ...
  for ($nn=0;$nn<count($mPrn);$nn++) {
    if (strlen($mPrn[$nn]) > 0) {
      ...
      $qCodDat .= "LEFT JOIN $cAlfa.SIAI0150 ON $cAlfa.fcod$cAno.teridxxx = $cAlfa.SIAI0150.CLIIDXXX ";
          ...
          $xRCD['ctodesxx'] = ($vCtoCon['ctodesx'.strtolower($xRCD['comctoc2'])] <> "") ? $vCtoCon['ctodesx'.strtolower($xRCD['comctoc2'])] : $vCtoCon['ctodesxx'];
          $xRCD['ctodesxx'] = ($xRCD['ctodesxx'] <> "") ? $xRCD['ctodesxx'] : "CONCEPTO SIN DESCRIPCION";
          ...
          //while ($mCodDat[$k] = mysql_fetch_array($xCodDat)) 	{ //CURSOR PARA RECORRER LA GRILLA //
              ...
              ##Fin Impresión de Logo de ADIMPEX en la parte superior derecha##
                ...
                case "TETRLXXXXX"://TRLXXXXX
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logobma1.jpg',11,11,35,10);
                break;
								case "TEADIMPEXX": // ADIMPEX
								case "DEADIMPEXX": // ADIMPEX
								case "ADIMPEXX": // ADIMPEX
                ...
                case "DEALADUANA": //ALADUANA
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logoaladuana.jpg',16,8,30,15);
								...
								case "DEANDINOSX": //ANDINOSX
									$pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoAndinos2.jpeg', 20, $py + 7, 18, 18);
								break;
                ...
                case "AAINTERX": //AAINTERX
                  ...
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logointernacional.jpg', 14,$py+7, 33, 18);
								...
								case "TEAALOPEZX":
								case "DEAALOPEZX":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoaalopez.png', 13, $py + 7, 30);
								break;
                ...
                case "TEMANATIAL":
                case "DEMANATIAL":
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logomanantial.jpg',11,9,36,10);
                break;
                case "DSVSASXX":
                case "TEDSVSASXX":
                case "DEDSVSASXX":
                ...
                case "DEFEDEXEXP":
                case "TEFEDEXEXP":
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logofedexexp.jpg',13,8,33,15);
                break;
								case "EXPORCOM":
								case "DEEXPORCOM":
								case "TEEXPORCOM":
              ...
              if( !(( $cAlfa == "DEROLDANLO" || $cAlfa == "TEROLDANLO" || $cAlfa == "ROLDANLO" ) && ( $cComId."-".str_pad($cComCod,3,'0',STR_PAD_LEFT) == "L-011" )) ){
                $pdf->SetFont('verdana','',7);
         				$pdf->setXY(10,32);
                ...
                break;
  					...
  					$pdf->Cell(18,3,$mCodDat[$k]['sccidxxx'],0,0,'L');
						...
						$pdf->cell($nPosPucDes,3,substr($mCodDat[$k]['ctodesxx'],0,22),0,0,'L');
  		  ...
  		  if ($nFilCoc > 0 && $nFilCod > 0) {
                ...
                case "TEMIRCANAX": //MIRCANAX
	              ...
	              break;
								...
								case "DEACODEXXX":
								case "TEACODEXXX":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logo_acodex.jpg',12,$py+1,36,19);
								break;
								case "LOGINCAR":
								case "DELOGINCAR":
								case "TELOGINCAR":
                ...
                case "AAINTERX": //AAINTERX
                  ...
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logointernacional.jpg', 14,$py+7, 33, 18);
								...
								case "TEAALOPEZX":
								case "DEAALOPEZX":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoaalopez.png', 13, $py + 3, 30);
								break;
								case "SOLUCION": //SOLUCION
								case "TESOLUCION": //SOLUCION
								case "DESOLUCION": //SOLUCION
								...
								case "TEFENIXSAS": //FENIXSAS
								case "DEFENIXSAS": //FENIXSAS
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logofenix.jpg', 12, $py+5, 36);
								break;
								case "COLVANXX": //COLVANXX
								case "TECOLVANXX": //COLVANXX
								case "DECOLVANXX": //COLVANXX
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logocolvan.jpg', 12, $py+2, 36);
								break;
								case "INTERLAC": //INTERLAC
								case "TEINTERLAC": //INTERLAC
								case "DEINTERLAC": //INTERLAC
                ...
                case "TEMANATIAL":
                case "DEMANATIAL":
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logomanantial.jpg',11,$py+5,36,10);
                break;
                case "DSVSASXX":
                case "TEDSVSASXX":
                case "DEDSVSASXX":
                ...
                case "DEFEDEXEXP":
                case "TEFEDEXEXP":
                  $pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logofedexexp.jpg',17,$py+4,25,15);
                break;
								case "EXPORCOM":
								case "DEEXPORCOM":
								case "TEEXPORCOM":
								...
								case "DEHAYDEARX":
								case "TEHAYDEARX":
									$pdf->Image($_SERVER['DOCUMENT_ROOT'].$cPlesk_Skin_Directory.'/logohaydear.jpeg',14,$py+2,32,15);
								break;
								case "CONNECTA":
								case "DECONNECTA":
								case "TECONNECTA":
              ...
              $pdf->SetFont('verdana','',7);
                ...
                break;
  					...
  					$pdf->Cell(18,3,$mCodDat[$k]['sccidxxx'],0,0,'L');
						...
						$pdf->cell($nPosPucDes,3,substr($mCodDat[$k]['ctodesxx'],0,22),0,0,'L');
						$pdf->cell($nPosComObs,3,substr($mCodDat[$k]['comobsxx'],0,21),0,0,'L');
						// If para mostrar en la grilla el valor de credito y debito ///
						$nComVlr = ($mCodDat[$k]['comvlrxx'] > 0) ? $mCodDat[$k]['comvlrxx'] : $mCodDat[$k]['comvlrnf'];
						if ($mCodDat[$k]['commovxx'] == 'C') {
							//$pdf->setXY($posxdb,$posy); //Debito //Credito
  				...
  				if($P < 20) {// CUANDO SON POCOS REGISTROS  " pregunto si la grilla es menor que 20 para pintar "
  					...
  					$pdf->Cell(40,3,'TOTAL : ',0,0,'R');
						$pdf->Cell(30,3,'$'.((strpos(($total1+0),'.') > 0) ? number_format(($total1+0),2,',','.') : number_format(($total1+0),0,',','.')),0,0,'R');
  					$py1+=1;
