...
if (!empty($gModo) && !empty($gFunction) && !empty($gSecuencia)) { ?>
  <html>
    <head>
      ...
      <script languaje = 'javascript'>
        function fnCarga_Grilla(xRows) {
          switch (xRows) {
            case "1":
              if (document.forms['frgrm']['oChkTra'].checked == true) {
                var mComCru = document.forms['frgrm']['oChkTra'].id.split("~");
                if(parent.window.opener.fnValidateExist(mComCru[0], mComCru[1], mComCru[2])) {
                  break;
                }
                ...
                for (i=0;i<document.forms['frgrm']['oChkTra'].length;i++){
                  if (document.forms['frgrm']['oChkTra'][i].checked == true) {
                    ...
                    if (nSwPrv == 0) { // Si es la primera vez que entre cambio el estado del switch
                      ...
                      parent.window.opener.fnAddNewRowDo();
                    }
                      ...
                      case "VALID":
                        ...
                        if (mysql_num_rows($xTramites) == 1) {
                          ...
                          <script language="javascript">
                            if(!parent.fmwork.fnValidateExist('<?php echo $vTramites['sucidxxx'] ?>', '<?php echo $vTramites['docidxxx'] ?>', '<?php echo $vTramites['docsufxx'] ?>')) {
                        ...
                        if (mysql_num_rows($xTramites) > 0) { ?>
                          ...
                          <table cellspacing = "0" cellpadding = "1" border = "1" width = "760">
                            <tr>
                              ...
                              <td width = "020" Class = "name"><center><input type="checkbox" name="oChkTraAll" onClick = "javascript:fnMarca('<?php echo mysql_num_rows($xTramites) ?>')"></center></td>
                            </tr>
                              ...
                              <td colspan="8">
                                <center>
                                  <input type="button" name="Btn_Aceptar" value = "Aceptar" style="width:100;text-align:center"
                                        onclick="javascript:fnCarga_Grilla('<?php echo count($mTramites) ?>');" readonly>
