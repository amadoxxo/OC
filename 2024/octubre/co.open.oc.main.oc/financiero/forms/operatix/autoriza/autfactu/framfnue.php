...
<head>
      ...
      switch (xLink){
        case "cDocId":
          ...
          if (document.forms['frgrm']['cDocId'+xSecuencia].value != "") {
            if (xSwitch == "VALID") {           
              var cRuta  = "frafa121.php?gModo=VALID&gFunction="+xLink+
              ...
              var cRuta   = "framffrm.php?gModo=WINDOW&gArchivo=frafa121.php&gFunction="+xLink+
                            "&gDocId="+document.forms['frgrm']['cDocId'+xSecuencia].value.toUpperCase()+
                            "&gSecuencia="+xSecuencia;
              // alert(cRuta);
    ...
    function f_Add_New_Row_Do() {
      ...
      TD_xAll.style.border = "1px solid #E6E6E6";
      TD_xAll.innerHTML    = "<input type = 'text' class = 'letra' style = 'width:260;border:0;text-align:left' name = '"+cCliNom+"' id = '"+cCliNom+"' onKeyUp='javascript:f_Enter(event,this.name,\"Grid_Do\");' readonly>";
    ...
    function fnPegarDo() {
      ...
      var cPathUrl = "framffrm.php?gFunction=PegarDo&gArchivo=framfcpd.php"+
    ...
    function f_Guardar(){
      ...
      if (confirm("Esta Seguro de Autorizar para Facturacion Manual los DO Seleccionados?")) {
        ...
        <tr>
          <td>
            <fieldset>
              ...
              <form name = 'frgrm' action = 'frafagra.php' method = 'post' target='fmpro'>
