	  							...
	  							switch ($gWhat) {
															...
															if (mysql_num_rows($xCiuDes) > 1) { ?>
																...
																<?php
      															...
      															case "cCiuId1":
      																?>
      																	<td width = "050" class= "name">
      																		<a href = "javascript:window.opener.document.forms['frgrm']['cCiuId1'].value  ='<?php echo $xCD['CIUIDXXX']?>';
      																													window.opener.document.forms['frgrm']['cCiuDes1'].value ='<?php echo $xCD['CIUDESXX']?>';
      																													close()"><?php echo $xCD['CIUIDXXX'] ?></a></td>
      																	<td width = "400" class= "name"> <?php echo $xCD['CIUDESXX'] ?></td>
      																	<td width = "050" class= "name"> <?php echo $xCD['REGESTXX'] ?></td>
      																</tr>
      															...
      															break;
        															...
        															switch ($gFunction) {
															           ...
															           case "cCiuId1":
            															?>
            																<script languaje="javascript">
            																	window.opener.document.forms['frgrm']['cCiuId1'].value  = '<?php echo $xCD['CIUIDXXX'] ?>';
            																	window.opener.document.forms['frgrm']['cCiuDes1'].value = '<?php echo $xCD['CIUDESXX'] ?>';
            																	close();
            																</script>
															           <?php
	  								...
	  								case "VALID":
    	      	      				...
    	      	      				case "cCiuId1":
    	  										?>
    													<script languaje = "javascript">
    														parent.fmwork.document.forms['frgrm']['cCiuId1'].value  = '<?php echo $xCD['CIUIDXXX'] ?>';
    														parent.fmwork.document.forms['frgrm']['cCiuDes1'].value = '<?php echo $xCD['CIUDESXX'] ?>';
    														close();
    													</script>
    	      	      				<?php
    	      	      				break;
												...
												<script languaje = "javascript">
												  //parent.fmwork.document.forms['frgrm']['cCiuId'].value  = "";
