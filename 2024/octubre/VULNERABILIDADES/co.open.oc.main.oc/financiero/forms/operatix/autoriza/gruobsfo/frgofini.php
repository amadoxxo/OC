<?php
  namespace openComex;
/**
 * Tracking Grupo de Observaciones para Formularios.
 * Este programa permite realizar consultas rapidas de los Grupo de Observaciones para Formularios que se Encuentran en la Base de Datos.
...
<html>
	<head>
  	<LINK rel = 'stylesheet' href = '<?php echo $cSystem_Libs_JS_Directory ?>/estilo.css'>
   	...
   	<script language="javascript">
    	...
    	function f_Ver(xGofTip,xGofId) {
      	var ruta = "frgofnue.php?gGofTip="+xGofTip+"&gGofId="+xGofId;
      	document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	document.cookie="kMenDes=Ver Grupo de Observacion;path="+"/";
				...
				switch (document.forms['frgrm']['vRecords'].value) {
					case "1":
						if (document.forms['frgrm']['oChkCom'].checked == true) {
							...
							var ruta = "frgofnue.php?gGofTip="+zMatriz[0]+"&gGofId="+zMatriz[1];
      	      document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
      	      document.cookie="kMenDes=Editar Grupo de Observacion;path="+"/";
				 ...
				 if (document.forms['frgrm']['vRecords'].value!="0"){
  				switch (document.forms['frgrm']['vRecords'].value) {
  					case "1":
  						if (document.forms['frgrm']['oChkCom'].checked == true) {
   						  var zMatriz = document.forms['frgrm']['oChkCom'].id.split('-');
   						  if (confirm("Esta Seguro de Cambiar el Estado del Grupo de Observacion No. "+zMatriz[1]+" ?")) {
									document.cookie="kIniAnt=<?php echo substr($_SERVER['PHP_SELF'],(strrpos($_SERVER['PHP_SELF'],"/")+1),strlen($_SERVER['PHP_SELF'])) ?>;path="+"/";
    							document.forms['frestado']['cGofTip'].value=zMatriz[0];
    							document.forms['frestado']['cGofId'].value =zMatriz[1];
    							document.forms['frestado']['cGofEst'].value=zMatriz[2];
          	      document.cookie="kModo="+xModo+";path="+"/";
  ...
  <body topmargin = "0" leftmargin = "0" rightmargin = "0" bottommargin = "0" marginheight = "0" marginwidth = "0">
		<form name = "frestado" action = "frgofgra.php" method = "post" target="fmpro">
			<input type = "hidden" name = "cGofTip" value = "">
			<input type = "hidden" name = "cGofId" value = "">
			<input type = "hidden" name = "cGofEst" value = "">
		</form>

		<form name = "frgrm" action = "frgofini.php" method = "post" target="fmwork">
      ...
      <?php
        ...
        $y=0;
        $qDatTdi  = "SELECT * ";
				$qDatTdi .= "FROM $cAlfa.fpar0123 ";
				$qDatTdi .= "WHERE goftipxx = \"FORMULARIOS\" ";
				$qDatTdi .= "ORDER BY regfmodx DESC,reghmodx DESC";
	        ...
	        for ($i=0,$j=0;$i<count($zMatrizTmp);$i++) {
	          ...
	          $cCadena  = $zMatrizTmp[$i]['gofidxxx']."~";
	          $cCadena .= $zMatrizTmp[$i]['gofdesxx']."~";
      ...
      <center>
       	<table width="95%" cellspacing="0" cellpadding="0" border="0">
         	<tr>
	       	  <td>
				      <fieldset>
   			        <legend>Registros Seleccionados (<?php echo count($zMatrizTra)?>)</legend>
     	         	<center>
     	       		...
     	       		<center>
         	         	...
         	         	<tr bgcolor = '<?php echo $vSysStr['system_row_title_color_ini'] ?>'>
         	         		<td class="name" width="10%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','gofidxxx','ASC_NUM')" title="Ordenar"
       	       					onmouseover="javascript:f_ButtonsAscDes('onmouseover','gofidxxx','')"
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','gofidxxx','')">Id</a>&nbsp;
           	         		<img src="<?php echo $cPlesk_Skin_Directory ?>/spacer.png" border="0" width="11" height="9" title = "" id = "gofidxxx">
           	         		<script language="javascript">f_ButtonsAscDes('','gofidxxx','')</script>
           	         	</td>
           	         	<td class="name" width="40%">
           	         		<a href = "javascript:f_ButtonsAscDes('onclick','gofdesxx','ASC_AZ')" title="Ordenar"
       	       					...
       	       					onmouseout="javascript:f_ButtonsAscDes('onmouseout','gofdesxx','')">Descripci&oacute;n</a>&nbsp;
 	                    ...
 	                    <?php for ($i=intval($vLimInf);$i<intval($vLimInf+$vLimSup);$i++) {
 	                    	if ($i < count($zMatrizTra)) { // Para Controlar el Error
	                   	    ...
	                   	    if($y % 2 == 0) {
		                      	...
		                      	<td class="letra7" width="10%"><a href = javascript:f_Ver('<?php echo $zMatrizTra[$i]['goftipxx']?>','<?php echo $zMatrizTra[$i]['gofidxxx']?>')><?php echo $zMatrizTra[$i]['gofidxxx'] ?></a></td>
	       	                	<td class="letra7" width="40%"><?php echo $zMatrizTra[$i]['gofdesxx'] ?></td>
	            	            ...
	            	            <td Class="letra7" width="02%" align="right"><input type="checkbox" name="oChkCom"  value = "<?php echo count($zMatrizTra) ?>"
	                   	    		id="<?php echo $zMatrizTra[$i]['goftipxx'].'-'.$zMatrizTra[$i]['gofidxxx'].'-'.$zMatrizTra[$i]['regestxx']?>"
