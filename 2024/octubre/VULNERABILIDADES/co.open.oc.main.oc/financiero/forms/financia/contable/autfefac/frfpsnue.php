<?php 
  ...
  /**
   * Formulario Cambio de Fecha Prefactura (Sin Legalizar).
   * --- Descripcion: Permite Buscar las Prefacturas Sin Legalizar por Anio y Cambiar su Fecha.
...
<head>
  ...
  <script language = 'javascript'>
    ...
    function fnAddNewRowPre() {
      ...
      TD_xAll.style.border = "1px solid #E6E6E6";
      TD_xAll.innerHTML    = "<input type = 'text' class = 'letra' style = 'width:335;border:0;text-align:left' name = '"+cCliNom+"' id = '"+cCliNom+"' onKeyUp='javascript:f_Enter(event,this.name,\"Grid_Do\");' readonly>";
        ...
        <tr>
          <td>
            <fieldset>
              ...
              <form name = 'frgrm' action = 'frfpsgra.php' method = 'post' target='fmpro'>
