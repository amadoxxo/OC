                                    ...
                                    <tr>
                                      <td width = "100" class= "name">
                                          <a href = "javascript:window.opener.document.forms['frgrm']['cUfaId'+'<?php echo $gGrid.$gSecuencia ?>'].value  = '<?php echo $xRUF['ufaidxxx']?>';
                                                                window.opener.document.forms['frgrm']['cUfaDes'+'<?php echo $gGrid.$gSecuencia ?>'].value = '<?php echo $xRUF['ufadesxx']?>';
                      ...
                      case "VALID":
                        ...
                        if (mysql_num_rows($xUniFact) > 0){
                          if (mysql_num_rows($xUniFact) == 1){
                            while ($xRUF = mysql_fetch_array($xUniFact)) { 
                              ...
                              <script language = "javascript">
                                ...
                                parent.fmwork.document.forms['frgrm']['cUfaDes'+'<?php echo $gGrid.$gSecuencia ?>'].value = "<?php echo $xRUF['ufadesxx'] ?>";
                          ...
                          <script language = "javascript">
                            ...
                            parent.fmwork.document.forms['frgrm']['cUfaDes'+'<?php echo $gGrid.$gSecuencia ?>'].value = "";
                          </script>
                          <?php
                        }
                      break;
