              ...
              <table border="1" cellspacing="0" cellpadding="0" width="98%" align=center style="margin:5px">
                ...
                <tr bgcolor = "white" height="20" style="padding-left:10px;padding-top:5px">
                  ...
                  switch ($cAlfa) {
                    ...
                    case "DECONLOGIC":
                    case "TECONLOGIC":?>
                      <td class="name"><center><img width="120" height="80" style="left: 38px;margin-top: -40px;position: absolute;" src = "<?php echo $cPlesk_Skin_Directory ?>/logoconlogic.jpg"></td>
                    <?php
                    break;
                    case "OPENEBCO":
                    case "DEOPENEBCO":
          ...
          class PDF extends FPDF {
            ...
            if($cAlfa == "INTERLOG" || $cAlfa == "DESARROL" || $cAlfa == "PRUEBASX" ){
                ...
                switch ($cAlfa) {
                  ...
                  case "DECONLOGIC":
                  case "TECONLOGIC":
                    $this->Image($_SERVER['DOCUMENT_ROOT'] . $cPlesk_Skin_Directory . '/logoconlogic.jpg', 14,8.5,18,12);
                  break;
                  case "OPENEBCO":
                  case "DEOPENEBCO":
                  case "TEOPENEBCO":
