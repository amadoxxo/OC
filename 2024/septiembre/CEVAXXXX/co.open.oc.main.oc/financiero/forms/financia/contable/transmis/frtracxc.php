    ...
    switch ($zBand)	{
        ...
        for($i=1; $i<=count($zMatrizCar); $i++){
          ...
          if($zMatrizCar[$i]['ERROR']==0){
            $zIns1006 = array(array('NAME'=>'COMIDXXX','VALUE'=>trim(strtoupper($zMatrizCar[$i]['COMIDXXX']))  ,'CHECK'=>'SI'),
     				...
     				if (wMySql("INSERT","TEMP1006",$zIns1006,$xConexion01,$cAlfa)) {
     				}
          }
        }
        ...
        if($zError==0){
          ...
          $zSqlDel = "DELETE FROM $cAlfa.GRM01006";
				  mysql_query($zSqlDel,$xConexion01);
          
          $cSqlUpd = "INSERT INTO $cAlfa.GRM01006 SELECT * FROM $cAlfa.TEMP1006 ";
          $nCrsTbl = mysql_query($cSqlUpd,$xConexion01);
          
          $zSqlDel = "DROP TABLE $cAlfa.TEMP1006";
				  mysql_query($zSqlDel,$xConexion01);
        ...
        <form name = "frgrm" action = "<?php echo $_COOKIE['kIniAnt'] ?>" method = "post" target = "fmwork"></form>
		      ...
		      <table border="1" cellspacing="0" cellpadding="0" width="95%" align=center>
		        ...
		        <td class="letra7" width=100% align="center"><font size=2><b>ERRORES EN EL PROCESO DE ACTUALIZACION (CXC)</b></font></td>
		      </tr>
		      </table>
		      <table border="1" cellspacing="0" cellpadding="0" width="95%" align=center>
		      <tr height="20">
  				...
  				<table cellpadding="0" cellspacing="0" border="0" width="400">
  					<tr>
  						<td width="400" align="center">
  							<fieldset>
  							<legend>Actualizaci&oacute;n Cuentas por Cobrar</legend>
  							<form method='POST' enctype='multipart/form-data' action='frtracxc.php'>
